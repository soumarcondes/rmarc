...
function Qe(e, t, n, r) {
    return Ze(e, t, 1 - Math.exp(-n * r))
}
function $e(e, t=1) {
    return t - Math.abs(Je(e, t * 2) - t)
}
function et(e, t, n) {
...
var mt = {
  ...
  , G = class e {
    ...
    clamp(e, t) {
        return this.x = W(this.x, e.x, t.x),
        this.y = W(this.y, e.y, t.y),
        this
    }
    clampScalar(e, t) {
        return this.x = W(this.x, e, t),
        this.y = W(this.y, e, t),
        this
    }
    clampLength(e, t) {
  ...
  , K = class e {
    ...
    scale(e, t) {
        return this.premultiply(ht.makeScale(e, t)),
        this
    }
    rotate(e) {
        return this.premultiply(ht.makeRotation(-e)),
        this
    }
    translate(e, t) {
        return this.premultiply(ht.makeTranslation(e, t)),
        this
    }
    makeTranslation(e, t) {
...
var wt = new K().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322)
  , Tt = new K().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function Et() {
    let e = {
        enabled: !0,
        ...
        getTransfer: function(e) {
            return e === `` ? Le : this.spaces[e].transfer
        },
...
var kt, At = class {
    static getDataURL(e) {
        ...
        if (e instanceof HTMLCanvasElement)
            ...
            kt === void 0 && (kt = _t(`canvas`)),
            kt.width = e.width,
            kt.height = e.height;
            let n = kt.getContext(`2d`);
    ...
    static sRGBToLinear(e) {
        ...
        if (e.data) {
            ...
            for (let e = 0; e < t.length; e++)
                t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[e] = Math.floor(Dt(t[e] / 255) * 255) : t[e] = Dt(t[e]);
            return {
                data: t,
                width: e.width,
                height: e.height
        ...
        if (r !== null) {
            ...
            if (Array.isArray(r)) {
                ...
                for (let t = 0, n = r.length; t < n; t++)
                    r[t].isDataTexture ? e.push(Nt(r[t].image)) : e.push(Nt(r[t]))
            } else
                e = Nt(r);
            n.url = e
        }
...
;
function Nt(e) {
    return typeof HTMLImageElement < `u` && e instanceof HTMLImageElement || typeof HTMLCanvasElement < `u` && e instanceof HTMLCanvasElement || typeof ImageBitmap < `u` && e instanceof ImageBitmap ? At.getDataURL(e) : e.data ? {
...
var Pt = 0
  , Ft = class e extends He {
    constructor(t=e.DEFAULT_IMAGE, n=e.DEFAULT_MAPPING, r=s, i=s, a=f, o=m, c=k, l=h, u=e.DEFAULT_ANISOTROPY, d=``) {
        super(),
        this.isTexture = !0,
        Object.defineProperty(this, "id", {
            value: Pt++
...
var J = class e {
  ...
  , It = class extends He {
    constructor(e=1, t=1, n={}) {
        ...
        let i = new Ft(r,n.mapping,n.wrapS,n.wrapT,n.magFilter,n.minFilter,n.format,n.type,n.anisotropy,n.colorSpace);
        i.flipY = !1,
    ...
    copy(e) {
        ...
        return this.texture.source = new Mt(t),
  ...
  , Y = class e {
    ...
    projectOnPlane(e) {
        return Vt.copy(this).projectOnVector(e),
        this.sub(Vt)
    }
    reflect(e) {
  ...
  , Ut = class {
    ...
    setFromCenterAndSize(e, t) {
        let n = Gt.copy(t).multiplyScalar(.5);
        ...
        if (n !== void 0) {
            ...
            if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0)
                for (let t = 0, n = r.count; t < n; t++)
                    e.isMesh === !0 ? e.getVertexPosition(t, Gt) : Gt.fromBufferAttribute(r, t),
                    Gt.applyMatrix4(e.matrixWorld),
                    this.expandByPoint(Gt);
            else
                e.boundingBox === void 0 ? (n.boundingBox === null && n.computeBoundingBox(),
                Kt.copy(n.boundingBox)) : (e.boundingBox === null && e.computeBoundingBox(),
                Kt.copy(e.boundingBox)),
    ...
    intersectsSphere(e) {
        return this.clampPoint(e.center, Gt),
    ...
    intersectsTriangle(e) {
        ...
        Zt.subVectors(Yt, Jt),
        Qt.subVectors(qt, Yt);
        let t = [0, -Xt.z, Xt.y, 0, -Zt.z, Zt.y, 0, -Qt.z, Qt.y, Xt.z, 0, -Xt.x, Zt.z, 0, -Zt.x, Qt.z, 0, -Qt.x, -Xt.y, Xt.x, 0, -Zt.y, Zt.x, 0, -Qt.y, Qt.x, 0];
        return !rn(t, qt, Jt, Yt, en) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1],
        !rn(t, qt, Jt, Yt, en)) ? !1 : (tn.crossVectors(Xt, Zt),
        t = [tn.x, tn.y, tn.z],
        rn(t, qt, Jt, Yt, en))
    }
    clampPoint(e, t) {
    ...
    getBoundingSphere(e) {
        ...
        e.radius = this.getSize(Gt).length() * .5),
        e
    }
    intersect(e) {
  ...
  , Wt = [new Y, new Y, new Y, new Y, new Y, new Y, new Y, new Y]
  , Gt = new Y
  , Kt = new Ut
  , qt = new Y
  , Jt = new Y
...
function rn(e, t, n, r, i) {
    for (let a = 0, o = e.length - 3; a <= o; a += 3) {
        nn.fromArray(e, a);
        let o = i.x * Math.abs(nn.x) + i.y * Math.abs(nn.y) + i.z * Math.abs(nn.z)
          , s = t.dot(nn)
          , c = n.dot(nn)
          , l = r.dot(nn);
...
var an = new Ut
  ...
  , cn = class {
    ...
    setFromPoints(e, t) {
        let n = this.center;
        t === void 0 ? an.setFromPoints(e).getCenter(n) : n.copy(t);
        let r = 0;
    ...
    expandByPoint(e) {
        ...
        if (t > this.radius * this.radius) {
            let e = Math.sqrt(t)
              , n = (e - this.radius) * .5;
            this.center.addScaledVector(on, n / e),
            this.radius += n
        }
        return this
    }
    union(e) {
        ...
        this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (sn.subVectors(e.center, this.center).setLength(e.radius),
        this.expandByPoint(on.copy(e.center).add(sn)),
        this.expandByPoint(on.copy(e.center).sub(sn))),
        this)
    }
    equals(e) {
  ...
  , gn = class {
    ...
    recast(e) {
        return this.origin.copy(this.at(e, ln)),
        this
    }
    ...
    distanceSqToPoint(e) {
        ...
        return t < 0 ? this.origin.distanceToSquared(e) : (ln.copy(this.origin).addScaledVector(this.direction, t),
        ln.distanceToSquared(e))
    }
    distanceSqToSegment(e, t, n, r) {
        un.copy(e).add(t).multiplyScalar(.5),
        dn.copy(t).sub(e).normalize(),
        fn.copy(this.origin).sub(un);
        let i = e.distanceTo(t) * .5, a = -this.direction.dot(dn), o = fn.dot(this.direction), s = -fn.dot(dn), c = fn.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
        if (l > 0)
            if (u = a * s - o,
            d = a * o - s,
            p = i * l,
        ...
        r && r.copy(un).addScaledVector(dn, d),
        f
    }
    intersectSphere(e, t) {
        ln.subVectors(e.center, this.origin);
        let n = ln.dot(this.direction)
          , r = ln.dot(ln) - n * n
          , i = e.radius * e.radius;
        if (r > i)
            return null;
    ...
    intersectTriangle(e, t, n, r, i) {
        pn.subVectors(t, e),
        mn.subVectors(n, e),
        hn.crossVectors(pn, mn);
        let a = this.direction.dot(hn), o;
        if (a > 0) {
            if (r)
                return null;
            o = 1
        ...
        let s = o * this.direction.dot(mn.crossVectors(fn, mn));
        if (s < 0)
            return null;
        let c = o * this.direction.dot(pn.cross(fn));
        if (c < 0 || s + c > a)
            return null;
        let l = -o * fn.dot(hn);
  ...
  , _n = class e {
    ...
    extractRotation(e) {
        let t = this.elements
          ...
          , a = 1 / vn.setFromMatrixColumn(e, 2).length();
        return t[0] = n[0] * r,
        t[1] = n[1] * r,
        t[2] = n[2] * r,
        t[3] = 0,
    ...
    lookAt(e, t, n) {
        let r = this.elements;
        return wn.subVectors(e, t),
        wn.lengthSq() === 0 && (wn.z = 1),
        wn.normalize(),
        Sn.crossVectors(n, wn),
        Sn.lengthSq() === 0 && (Math.abs(n.z) === 1 ? wn.x += 1e-4 : wn.z += 1e-4,
        wn.normalize(),
        Sn.crossVectors(n, wn)),
        Sn.normalize(),
        Cn.crossVectors(wn, Sn),
        r[0] = Sn.x,
        r[4] = Cn.x,
        r[8] = wn.x,
        r[1] = Sn.y,
    ...
    decompose(e, t, n) {
        let r = this.elements
          ...
          , a = vn.set(r[4], r[5], r[6]).length()
          , o = vn.set(r[8], r[9], r[10]).length();
        ...
        yn.elements[9] *= l,
        yn.elements[10] *= l,
        t.setFromRotationMatrix(yn),
        n.x = i,
        n.y = a,
        n.z = o,
        this
    }
    makePerspective(e, t, n, r, i, a, o=Ve) {
    ...
    makeOrthographic(e, t, n, r, i, a, o=Ve) {
  ...
  , Dn = class e {
    ...
    setFromQuaternion(e, t, n) {
        ...
        this.setFromRotationMatrix(Tn, t, n)
    }
    setFromVector3(e, t=this._order) {
        return this.set(e.x, e.y, e.z, t)
    }
    reorder(e) {
        return En.setFromEuler(this),
        this.setFromQuaternion(En, e)
    }
    equals(e) {
...
var On = class {
  ...
  , Wn = class e extends He {
    ...
    translateOnAxis(e, t) {
        return An.copy(e).applyQuaternion(this.quaternion),
        this.position.add(An.multiplyScalar(t)),
        this
    }
    translateX(e) {
    ...
    lookAt(e, t, n) {
        ...
        Pn.setFromMatrixPosition(this.matrixWorld),
        this.isCamera || this.isLight ? Mn.lookAt(Pn, Nn, this.up) : Mn.lookAt(Nn, Pn, this.up),
        this.quaternion.setFromRotationMatrix(Mn),
        r && (Mn.extractRotation(r.matrixWorld),
        jn.setFromRotationMatrix(Mn),
    ...
    getWorldQuaternion(e) {
        return this.updateWorldMatrix(!0, !1),
        this.matrixWorld.decompose(Pn, e, Fn),
        e
    }
    getWorldScale(e) {
        return this.updateWorldMatrix(!0, !1),
        this.matrixWorld.decompose(Pn, In, e),
        e
    }
    getWorldDirection(e) {
        this.updateWorldMatrix(!0, !1);
...
var Gn = new Y
  ...
  , ir = class e {
    ...
    static getInterpolation(e, t, n, r, i, a, o, s) {
        return this.getBarycoord(e, t, n, r, Jn) === null ? (s.x = 0,
        s.y = 0,
        `z` in s && (s.z = 0),
        `w` in s && (s.w = 0),
        null) : (s.setScalar(0),
        s.addScaledVector(i, Jn.x),
        s.addScaledVector(a, Jn.y),
        s.addScaledVector(o, Jn.z),
        s)
    }
    static getInterpolatedAttribute(e, t, n, r, i, a) {
        ...
        a.setScalar(0),
        a.addScaledVector(tr, i.x),
        a.addScaledVector(nr, i.y),
        a.addScaledVector(rr, i.z),
        a
    }
    static isFrontFacing(e, t, n, r) {
        return Gn.subVectors(n, t),
        Kn.subVectors(e, t),
        Gn.cross(Kn).dot(r) < 0
    }
    set(e, t, n) {
    ...
    getArea() {
        return Gn.subVectors(this.c, this.b),
        Kn.subVectors(this.a, this.b),
        Gn.cross(Kn).length() * .5
    }
    getMidpoint(e) {
    ...
    closestPointToPoint(e, t) {
        ...
        let h = l * p - f * u;
        if (h <= 0 && u - l >= 0 && f - p >= 0)
            return Zn.subVectors(i, r),
            o = (u - l) / (u - l + (f - p)),
            t.copy(r).addScaledVector(Zn, o);
        let g = 1 / (h + m + d);
        return a = m * g,
        o = d * g,
        t.copy(n).addScaledVector(Yn, a).addScaledVector(Xn, o)
    }
    equals(e) {
...
var X = class {
    ...
    setHSL(e, t, n, r=q.workingColorSpace) {
        ...
        return q.toWorkingColorSpace(this, r),
        this
    }
    setStyle(e, t=Fe) {
        function n(t) {
    ...
    setColorName(e, t=Fe) {
        ...
        return n === void 0 ? console.warn(`THREE.Color: Unknown color ` + e) : this.setHex(n, t),
        this
    }
    clone() {
    ...
    getHex(e=Fe) {
        return q.fromWorkingColorSpace(lr.copy(this), e),
        Math.round(W(lr.r * 255, 0, 255)) * 65536 + Math.round(W(lr.g * 255, 0, 255)) * 256 + Math.round(W(lr.b * 255, 0, 255))
    }
    getHexString(e=Fe) {
        return (`000000` + this.getHex(e).toString(16)).slice(-6)
    }
    getHSL(e, t=q.workingColorSpace) {
        q.fromWorkingColorSpace(lr.copy(this), t);
    ...
    getRGB(e, t=q.workingColorSpace) {
        return q.fromWorkingColorSpace(lr.copy(this), t),
        e.r = lr.r,
        e.g = lr.g,
        e.b = lr.b,
        e
    ...
    getStyle(e=Fe) {
        q.fromWorkingColorSpace(lr.copy(this), e);
        let t = lr.r
          , n = lr.g
          , r = lr.b;
    ...
    offsetHSL(e, t, n) {
        ...
        this.setHSL(or.h + e, or.s + t, or.l + n)
    }
    add(e) {
        return this.r += e.r,
        this.g += e.g,
...
var ur = 0
  ...
  , hr = class {
    ...
    setX(e, t) {
        return this.normalized && (t = pt(t, this.array)),
  ...
  , Er = class e extends He {
    ...
    setIndex(e) {
        return this.index = Array.isArray(e) ? new (gt(e) ? _r : gr)(e,1) : e,
        this
    }
    setIndirect(e) {
    ...
    applyQuaternion(e) {
        return br.makeRotationFromQuaternion(e),
        this.applyMatrix4(br),
        this
    }
    rotateX(e) {
        return br.makeRotationX(e),
        this.applyMatrix4(br),
        this
    }
    rotateY(e) {
        return br.makeRotationY(e),
        this.applyMatrix4(br),
        this
    }
    rotateZ(e) {
        return br.makeRotationZ(e),
        this.applyMatrix4(br),
        this
    }
    translate(e, t, n) {
        return br.makeTranslation(e, t, n),
        this.applyMatrix4(br),
        this
    }
    scale(e, t, n) {
        return br.makeScale(e, t, n),
        this.applyMatrix4(br),
        this
    }
    lookAt(e) {
        ...
        if (e !== void 0) {
            ...
            t)
                for (let e = 0, n = t.length; e < n; e++) {
                    ...
                    this.morphTargetsRelative ? (Tr.addVectors(this.boundingBox.min, Cr.min),
                    this.boundingBox.expandByPoint(Tr),
                    Tr.addVectors(this.boundingBox.max, Cr.max),
                    this.boundingBox.expandByPoint(Tr)) : (this.boundingBox.expandByPoint(Cr.min),
    ...
    computeBoundingSphere() {
        ...
        if (e) {
            ...
            if (Cr.setFromBufferAttribute(e),
            t)
                for (let e = 0, n = t.length; e < n; e++) {
                    let n = t[e];
                    wr.setFromBufferAttribute(n),
                    this.morphTargetsRelative ? (Tr.addVectors(Cr.min, wr.min),
                    Cr.expandByPoint(Tr),
                    Tr.addVectors(Cr.max, wr.max),
                    Cr.expandByPoint(Tr)) : (Cr.expandByPoint(wr.min),
                    Cr.expandByPoint(wr.max))
                }
            Cr.getCenter(n);
            let r = 0;
            for (let t = 0, i = e.count; t < i; t++)
                Tr.fromBufferAttribute(e, t),
                r = Math.max(r, n.distanceToSquared(Tr));
            if (t)
                for (let i = 0, a = t.length; i < a; i++) {
                    let a = t[i]
                      , o = this.morphTargetsRelative;
                    for (let t = 0, i = a.count; t < i; t++)
                        Tr.fromBufferAttribute(a, t),
                        o && (Sr.fromBufferAttribute(e, t),
                        Tr.add(Sr)),
                        r = Math.max(r, n.distanceToSquared(Tr))
                }
    ...
    computeVertexNormals() {
        ...
        if (t !== void 0) {
            ...
            if (n === void 0)
                n = new hr(new Float32Array(t.count * 3),3),
  ...
  , Rr = class extends Wn {
    ...
    getVertexPosition(e, t) {
        ...
        if (i && o) {
            ...
            for (let n = 0, r = i.length; n < r; n++) {
                let r = o[n]
                  , s = i[n];
                r !== 0 && (Pr.fromBufferAttribute(s, e),
                a ? Fr.addScaledVector(Pr, r) : Fr.addScaledVector(Pr.sub(t), r))
            }
            t.add(Fr)
        }
        return t
    ...
    raycast(e, t) {
        ...
        !(kr.containsPoint(Or.origin) === !1 && (Or.intersectSphere(kr, Ar) === null || Or.origin.distanceToSquared(Ar) > (e.far - e.near) ** 2)) && (Dr.copy(i).invert(),
        Or.copy(e.ray).applyMatrix4(Dr),
        (n.boundingBox === null || Or.intersectsBox(n.boundingBox) !== !1) && this._computeIntersections(e, t, Or)))
    }
...
function Br(e, t, n, r, i, a, o, s, c, l) {
    e.getVertexPosition(s, jr),
    e.getVertexPosition(c, Mr),
    e.getVertexPosition(l, Nr);
    let u = zr(e, t, n, r, jr, Mr, Nr, Ir);
    if (u) {
        let e = new Y;
        ir.getBarycoord(Ir, jr, Mr, Nr, e),
        i && (u.uv = ir.getInterpolatedAttribute(i, s, c, l, e, new G)),
        a && (u.uv1 = ir.getInterpolatedAttribute(a, s, c, l, e, new G)),
        o && (u.normal = ir.getInterpolatedAttribute(o, s, c, l, e, new Y),
        ...
        ir.getNormal(jr, Mr, Nr, t.normal),
        u.face = t,
        u.barycoord = e
    }
    return u
}
var Vr = class e extends Er {
...
var Kr = {
  ...
  , Yr = class extends dr {
    ...
    copy(e) {
        ...
        this.uniformsGroups = Wr(e.uniformsGroups),
  ...
  , Xr = class extends Wn {
    constructor() {
        ...
        this.isCamera = !0,
        this.type = `Camera`,
        this.matrixWorldInverse = new _n,
        this.projectionMatrix = new _n,
        this.projectionMatrixInverse = new _n,
  ...
  , ei = class extends Xr {
    ...
    getEffectiveFOV() {
        return Ke * 2 * Math.atan(Math.tan(Ge * .5 * this.fov) / this.zoom)
    }
    getFilmWidth() {
    ...
    getViewBounds(e, t, n) {
        Zr.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse),
        t.set(Zr.x, Zr.y).multiplyScalar(-e / Zr.z),
        Zr.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse),
        n.set(Zr.x, Zr.y).multiplyScalar(-e / Zr.z)
    }
    getViewSize(e, t) {
        return this.getViewBounds(e, Qr, $r),
        t.subVectors($r, Qr)
    }
    ...
    updateProjectionMatrix() {
        let e = this.near
          , t = e * Math.tan(Ge * .5 * this.fov) / this.zoom
          , n = 2 * t
          , r = this.aspect * n
          , i = -.5 * r
          , a = this.view;
  ...
  , ai = class extends Lt {
    constructor(e=1, t={}) {
        ...
        let n = {
          ...
          , r = [n, n, n, n, n, n];
        this.texture = new ii(r,t.mapping,t.wrapS,t.wrapT,t.magFilter,t.minFilter,t.format,t.type,t.anisotropy,t.colorSpace),
        this.texture.isRenderTargetTexture = !0,
        this.texture.generateMipmaps = t.generateMipmaps !== void 0 && t.generateMipmaps,
        this.texture.minFilter = t.minFilter === void 0 ? f : t.minFilter
    }
    fromEquirectangularTexture(e, t) {
        ...
        let a = new Rr(r,i)
          , o = t.minFilter;
        return t.minFilter === 1008 && (t.minFilter = f),
        new ri(1,10,this).update(e, a),
        t.minFilter = o,
        a.geometry.dispose(),
        a.material.dispose(),
        this
  ...
  , di = class {
    ...
    setFromCoplanarPoints(e, t, n) {
        let r = ci.subVectors(n, t).cross(li.subVectors(e, t)).normalize();
    ...
    applyMatrix4(e, t) {
        let n = t || ui.getNormalMatrix(e)
          , r = this.coplanarPoint(ci).applyMatrix4(e)
  ...
  , mi = class {
    ...
    setFromProjectionMatrix(e, t=Ve) {
        let n = this.planes
          , r = e.elements
          , i = r[0]
          , a = r[1]
          ...
          , v = r[14]
          , y = r[15];
        if (n[0].setComponents(s - i, d - c, h - f, y - g).normalize(),
    ...
    intersectsObject(e) {
        if (e.boundingSphere !== void 0)
            ...
            fi.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
        else {
            let t = e.geometry;
    ...
    intersectsSprite(e) {
        return fi.center.set(0, 0, 0),
        fi.radius = .7071067811865476,
    ...
    intersectsBox(e) {
        ...
        for (let n = 0; n < 6; n++) {
            let r = t[n];
            if (pi.x = r.normal.x > 0 ? e.max.x : e.min.x,
  ...
  , Ci = class extends Wn {
    ...
    computeLineDistances() {
        ...
        if (e.index === null) {
            ...
            for (let e = 1, r = t.count; e < r; e++)
                gi.fromBufferAttribute(t, e - 1),
                _i.fromBufferAttribute(t, e),
                n[e] = n[e - 1],
                n[e] += gi.distanceTo(_i);
            e.setAttribute(`lineDistance`, new vr(n,1))
        } else
    ...
    raycast(e, t) {
        ...
        bi.copy(n.boundingSphere),
        bi.applyMatrix4(r),
        bi.radius += i,
        e.ray.intersectsSphere(bi) === !1)
            return;
        vi.copy(r).invert(),
        yi.copy(e.ray).applyMatrix4(vi);
        ...
        if (l !== null) {
            ...
            for (let i = n, a = r - 1; i < a; i += c) {
                let n = l.getX(i)
                  , r = l.getX(i + 1)
                  , a = wi(this, e, yi, s, n, r);
                a && t.push(a)
            }
            if (this.isLineLoop) {
                let i = l.getX(r - 1)
                  , a = l.getX(n)
                  , o = wi(this, e, yi, s, i, a);
                o && t.push(o)
            }
        } else {
            let n = Math.max(0, a.start)
            ...
            for (let i = n, a = r - 1; i < a; i += c) {
                let n = wi(this, e, yi, s, i, i + 1);
                n && t.push(n)
            }
            if (this.isLineLoop) {
                let i = wi(this, e, yi, s, r - 1, n);
                i && t.push(i)
            }
        }
    }
...
function wi(e, t, n, r, i, a) {
    ...
    if (gi.fromBufferAttribute(o, i),
    _i.fromBufferAttribute(o, a),
    n.distanceSqToSegment(gi, _i, xi, Si) > r)
        return;
    xi.applyMatrix4(e.matrixWorld);
    let s = t.ray.origin.distanceTo(xi);
    if (!(s < t.near || s > t.far))
        return {
            distance: s,
            point: Si.clone().applyMatrix4(e.matrixWorld),
            index: i,
            face: null,
            faceIndex: null,
            barycoord: null,
...
var Ti = new Y
    ...
    computeLineDistances() {
        ...
        if (e.index === null) {
            ...
            for (let e = 0, r = t.count; e < r; e += 2)
                ...
                Ei.fromBufferAttribute(t, e + 1),
                n[e] = e === 0 ? 0 : n[e - 1],
                n[e + 1] = n[e] + Ti.distanceTo(Ei);
            e.setAttribute(`lineDistance`, new vr(n,1))
        } else
  ...
  , Ai = class extends Ft {
    constructor(e, t, n, r, i, a, o, s, c, u=ee) {
        if (u !== 1026 && u !== 1027)
            throw Error(`DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat`);
        n === void 0 && u === 1026 && (n = b),
        n === void 0 && u === 1027 && (n = T),
        super(null, r, i, a, o, s, u, n, c),
        this.isDepthTexture = !0,
        this.image = {
            width: e,
            height: t
        },
        this.magFilter = o === void 0 ? l : o,
        this.minFilter = s === void 0 ? l : s,
        this.flipY = !1,
        this.generateMipmaps = !1,
    ...
    constructor(e=1, t=1, n=1, r=32, i=1, a=!1, o=0, s=Math.PI * 2) {
            ...
            for (let n = 0; n < r; n++)
                for (let r = 0; r < i; r++) {
                    let a = m[r][n]
                      ...
                      , s = m[r + 1][n + 1]
                      , c = m[r][n + 1];
                    (e > 0 || r !== 0) && (l.push(a, o, c),
                    v += 3),
                    (t > 0 || r !== i - 1) && (l.push(o, s, c),
                    v += 3)
                }
            c.addGroup(g, v, 0),
            g += v
        ...
        function v(n) {
            ...
            for (let e = 0; e < r; e++) {
                let t = i + e
                  , r = b + e;
                n === !0 ? l.push(r, r + 1, t) : l.push(r + 1, r, t),
                _ += 3
            }
            c.addGroup(g, _, n === !0 ? 1 : 2),
            g += _
        }
    }
    copy(e) {
        ...
        e !== null) {
                ...
                l[0] !== l[1] && l[1] !== l[2] && l[2] !== l[0])
                    for (let e = 0; e < 3; e++) {
                        let t = (e + 1) % 3
                          ...
                          , f = `${n}_${i}`
                          , p = `${i}_${n}`;
                        p in u && u[p] ? (Fi.dot(u[p].normal) <= r && (d.push(a.x, a.y, a.z),
                        d.push(o.x, o.y, o.z)),
                        u[p] = null) : f in u || (u[f] = {
                            index0: s[e],
                            index1: s[t],
            ...
            for (let e in u)
                if (u[e]) {
                    ...
                    Ni.fromBufferAttribute(a, t),
                    Pi.fromBufferAttribute(a, n),
                    d.push(Ni.x, Ni.y, Ni.z),
                    d.push(Pi.x, Pi.y, Pi.z)
                }
...
var Gi = class {
  ...
  , Yi = class {
    constructor(e, t, n, r) {
        ...
        this.name = e,
        this.times = Ui(t, this.TimeBufferType),
        this.values = Ui(n, this.ValueBufferType),
    ...
    validate() {
        ...
        let n = this.times
          , r = this.values
          , i = n.length;
        i === 0 && (console.error(`THREE.KeyframeTrack: Track is empty.`, this),
        e = !1);
        let a = null;
        for (let t = 0; t !== i; t++) {
            let r = n[t];
...
Yi.prototype.DefaultInterpolation = Oe;
...
Xi.prototype.DefaultInterpolation = De,
...
ta.prototype.DefaultInterpolation = De,
...
var ra = class extends Wn {
  ...
  , fa = class extends ca {
    constructor() {
        ...
        this._cubeDirections = [new Y(1,0,0), new Y(-1,0,0), new Y(0,0,1), new Y(0,0,-1), new Y(0,1,0), new Y(0,-1,0)],
        this._cubeUps = [new Y(0,1,0), new Y(0,1,0), new Y(0,1,0), new Y(0,1,0), new Y(0,0,1), new Y(0,0,-1)]
    }
    updateMatrices(e, t=0) {
        ...
        n.position.copy(ua),
        da.copy(n.position),
        da.add(this._cubeDirections[t]),
        n.up.copy(this._cubeUps[t]),
        n.lookAt(da),
        n.updateMatrixWorld(),
        r.makeTranslation(-ua.x, -ua.y, -ua.z),
        la.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse),
        this._frustum.setFromProjectionMatrix(la)
    }
}
  , pa = class extends ra {
...
var xa = `\\[\\]\\.:\\/`
  ...
  , wa = `[^` + xa.replace(`\\.`, ``) + `]`
  , Ta = `((?:WC+[\\/:])*)`.replace(`WC`, Ca)
  , Ea = `(WCOD+)?`.replace(`WCOD`, wa)
  , Da = `(?:\\.(WC+)(?:\\[(.+)\\])?)?`.replace(`WC`, Ca)
  , Oa = `\\.(WC+)(?:\\[(.+)\\])?`.replace(`WC`, Ca)
  , ka = RegExp(`^` + Ta + Ea + Da + Oa + `$`)
  ...
  , Ma = class e {
    ...
    static sanitizeNodeName(e) {
        return e.replace(/\s/g, `_`).replace(Sa, ``)
    }
    static parseTrackName(e) {
        ...
        if (r !== void 0 && r !== -1) {
            ...
            Aa.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r),
            n.objectName = e)
        }
    ...
    bind() {
        ...
        this.targetObject = t,
        t.needsUpdate === void 0 ? t.matrixWorldNeedsUpdate !== void 0 && (s = this.Versioning.MatrixWorldNeedsUpdate) : s = this.Versioning.NeedsUpdate;
...
var Na = class {
    ...
    makeSafe() {
        let e = 1e-6;
        return this.phi = W(this.phi, e, Math.PI - e),
        this
    }
    setFromVector3(e) {
    ...
    setFromCartesianCoords(e, t, n) {
        ...
        this.phi = Math.acos(W(t / this.radius, -1, 1))),
        this
    }
    clone() {
        return new this.constructor().copy(this)
  ...
  , Pa = class extends Di {
    constructor(e=10, t=10, n=4473924, r=8947848) {
        ...
        let l = new Er;
        l.setAttribute(`position`, new vr(s,3)),
        l.setAttribute(`color`, new vr(c,3));
        let u = new hi({
            vertexColors: !0,
            toneMapped: !1
        });
...
void main() {
  ...
  , Ba = {
    basic: {
        uniforms: Ur([Q.common, Q.specularmap, Q.envmap, Q.aomap, Q.lightmap, Q.fog]),
        vertexShader: Z.meshbasic_vert,
        fragmentShader: Z.meshbasic_frag
    },
    lambert: {
        uniforms: Ur([Q.common, Q.specularmap, Q.envmap, Q.aomap, Q.lightmap, Q.emissivemap, Q.bumpmap, Q.normalmap, Q.displacementmap, Q.fog, Q.lights, {
            emissive: {
                value: new X(0)
            }
        }]),
    ...
    standard: {
        uniforms: Ur([Q.common, Q.envmap, Q.aomap, Q.lightmap, Q.emissivemap, Q.bumpmap, Q.normalmap, Q.displacementmap, Q.roughnessmap, Q.metalnessmap, Q.fog, Q.lights, {
            emissive: {
                value: new X(0)
            },
            roughness: {
    ...
    toon: {
        uniforms: Ur([Q.common, Q.aomap, Q.lightmap, Q.emissivemap, Q.bumpmap, Q.normalmap, Q.displacementmap, Q.gradientmap, Q.fog, Q.lights, {
            emissive: {
                value: new X(0)
            }
        }]),
    ...
    matcap: {
        uniforms: Ur([Q.common, Q.bumpmap, Q.normalmap, Q.displacementmap, Q.fog, {
            matcap: {
                value: null
            }
        }]),
    ...
    depth: {
        uniforms: Ur([Q.common, Q.displacementmap]),
        vertexShader: Z.depth_vert,
        fragmentShader: Z.depth_frag
    },
    normal: {
        uniforms: Ur([Q.common, Q.bumpmap, Q.normalmap, Q.displacementmap, {
            opacity: {
                value: 1
            }
        }]),
...
Ba.physical = {
    uniforms: Ur([Ba.standard.uniforms, {
        clearcoat: {
            value: 0
        },
        clearcoatMap: {
...
function Wa(e, t, n, r, i, a, o) {
    ...
    function m(e) {
        ...
        return r && r.isTexture && (r = (e.backgroundBlurriness > 0 ? n : t).get(r)),
        r
    }
    function h(t) {
        let n = !1
          , i = m(t);
        i === null ? _(s, c) : i && i.isColor && (_(i, 1),
        n = !0);
        let a = e.xr.getEnvironmentBlendMode();
        a === `additive` ? r.buffers.color.setClear(0, 0, 0, 1, o) : a === `alpha-blend` && r.buffers.color.setClear(0, 0, 0, 0, o),
    ...
    function g(t, n) {
        let r = m(n);
        r && (r.isCubeTexture || r.mapping === 306) ? (u === void 0 && (u = new Rr(new Vr(1,1,1),new Yr({
            name: `BackgroundCubeMaterial`,
            uniforms: Hr(Ba.backgroundCube.uniforms),
        ...
        i.update(u)),
        Ha.copy(n.backgroundRotation),
        Ha.x *= -1,
        Ha.y *= -1,
        Ha.z *= -1,
        r.isCubeTexture && r.isRenderTargetTexture === !1 && (Ha.y *= -1,
        Ha.z *= -1),
        u.material.uniforms.envMap.value = r,
        u.material.uniforms.flipEnvMap.value = r.isCubeTexture && r.isRenderTargetTexture === !1 ? -1 : 1,
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(Ua.makeRotationFromEuler(Ha)),
        u.material.toneMapped = q.getTransfer(r.colorSpace) !== Re,
        (d !== r || f !== r.version || p !== e.toneMapping) && (u.material.needsUpdate = !0,
        d = r,
        f = r.version,
        p = e.toneMapping),
        u.layers.enableAll(),
        t.unshift(u, u.geometry, u.material, 0, 0, null)) : r && r.isTexture && (l === void 0 && (l = new Rr(new Ri(2,2),new Yr({
            name: `BackgroundMaterial`,
            uniforms: Hr(Ba.background.uniforms),
        ...
        l.material.toneMapped = q.getTransfer(r.colorSpace) !== Re,
        r.matrixAutoUpdate === !0 && r.updateMatrix(),
        l.material.uniforms.uvTransform.value.copy(r.matrix),
        (d !== r || f !== r.version || p !== e.toneMapping) && (l.material.needsUpdate = !0,
        d = r,
        f = r.version,
        p = e.toneMapping),
        l.layers.enableAll(),
    ...
    function _(t, n) {
        t.getRGB(Va, Gr(e)),
        r.buffers.color.setClear(Va.r, Va.g, Va.b, n, o)
    }
    function v() {
...
function qa(e, t, n, r) {
    ...
    let d = n.logarithmicDepthBuffer === !0
      , f = n.reverseDepthBuffer === !0 && t.has(`EXT_clip_control`)
...
var Xa = 4
  ...
  , ao = (1 + Math.sqrt(5)) / 2
  , oo = 1 / ao
  , so = [new Y(-ao,oo,0), new Y(ao,oo,0), new Y(-oo,0,ao), new Y(oo,0,ao), new Y(0,ao,-oo), new Y(0,ao,oo), new Y(-1,1,-1), new Y(1,1,-1), new Y(-1,1,1), new Y(1,1,1)]
  , co = class {
    constructor(e) {
        this._renderer = e,
    ...
    fromScene(e, t=0, n=.1, r=100) {
        to = this._renderer.getRenderTarget(),
        no = this._renderer.getActiveCubeFace(),
        ro = this._renderer.getActiveMipmapLevel(),
        io = this._renderer.xr.enabled,
    ...
    compileEquirectangularShader() {
        this._equirectMaterial === null && (this._equirectMaterial = mo(),
    ...
    _cleanup(e) {
        this._renderer.setRenderTarget(to, no, ro),
        this._renderer.xr.enabled = io,
        e.scissorTest = !1,
    ...
    _allocateTargets() {
        ...
        if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
            ...
            let {_lodMax: r} = this;
            ({sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas} = lo(r)),
            this._blurMaterial = po(r, e, t)
        }
        return r
    }
    _compileMaterial(e) {
        let t = new Rr(this._lodPlanes[0],e);
        this._renderer.compile(t, $a)
    }
    _sceneToCubeUV(e, t, n, r) {
        let i = new ei(90,1,t,n)
          , a = [1, -1, 1, 1, 1, 1]
          , o = [1, 1, 1, -1, -1, -1]
          , s = this._renderer
          , c = s.autoClear
        ...
        for (let t = 0; t < 6; t++) {
            let n = t % 3;
            n === 0 ? (i.up.set(0, a[t], 0),
            i.lookAt(o[t], 0, 0)) : n === 1 ? (i.up.set(0, 0, a[t]),
            i.lookAt(0, o[t], 0)) : (i.up.set(0, a[t], 0),
            i.lookAt(0, 0, o[t]));
            let c = this._cubeSize;
            fo(r, n * c, t > 2 ? c : 0, c, c),
            s.setRenderTarget(r),
            f && s.render(d, i),
            s.render(e, i)
        }
    ...
    _textureToCubeUV(e, t) {
        ...
        r ? (this._cubemapMaterial === null && (this._cubemapMaterial = ho()),
        this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = mo());
        let i = r ? this._cubemapMaterial : this._equirectMaterial
          , a = new Rr(this._lodPlanes[0],i)
          , o = i.uniforms;
        o.envMap.value = e;
    ...
    _halfBlur(e, t, n, r, i, a, o) {
        ...
        let l = new Rr(this._lodPlanes[r],c)
          , u = c.uniforms
          , d = this._sizeLods[n] - 1
          , f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / 39
          , p = i / f
          , m = isFinite(i) ? 1 + Math.floor(3 * p) : Qa;
        m > Qa && console.warn(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Qa}`);
        let h = []
          , g = 0;
        for (let e = 0; e < Qa; ++e) {
            let t = e / p
        ...
        fo(t, 3 * v * (r > _ - Xa ? r - _ + Xa : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v),
        s.setRenderTarget(t),
        s.render(l, $a)
    }
}
...
function lo(e) {
    ...
    for (let o = 0; o < a; o++) {
        ...
        let h = new Er;
        h.setAttribute(`position`, new hr(f,3)),
        h.setAttribute(`uv`, new hr(p,2)),
        h.setAttribute(`faceIndex`, new hr(m,1)),
        t.push(h),
        i > Xa && i--
    }
    return {
    ...
    function r(r) {
        if (r && r.isTexture) {
            ...
            if (s || c) {
                ...
                {
                    let l = r.image;
                    return s && l && l.height > 0 || c && l && i(l) ? (n === null && (n = new co(e)),
...
function vo(e) {
    ...
    return {
        ...
        get: function(e) {
            let t = n(e);
            return t === null && bt(`THREE.WebGLRenderer: ` + e + ` extension not supported.`),
            t
        }
    }
}
...
function Co(e, t, n, r) {
    ...
    function a(a) {
        let o = r.render.frame
          , c = a.geometry
          , l = t.get(a, c);
        if (i.get(l) !== o && (t.update(l),
        i.set(l, o)),
        a.isInstancedMesh && (a.hasEventListener(`dispose`, s) === !1 && a.addEventListener(`dispose`, s),
...
function Ho(e, t) {
    ...
    if (r === void 0) {
        ...
        if (Fo(n, r))
            return;
        No.set(r),
        e.uniformMatrix2fv(this.addr, !1, No),
        Io(n, r)
    }
}
function Uo(e, t) {
    ...
    if (r === void 0) {
        ...
        if (Fo(n, r))
            return;
        Mo.set(r),
        e.uniformMatrix3fv(this.addr, !1, Mo),
        Io(n, r)
    }
}
function Wo(e, t) {
    ...
    if (r === void 0) {
        ...
        if (Fo(n, r))
            return;
        jo.set(r),
        e.uniformMatrix4fv(this.addr, !1, jo),
        Io(n, r)
    }
}
function Go(e, t) {
...
function $o(e, t, n) {
    ...
    r[0] = i);
    let a;
    this.type === e.SAMPLER_2D_SHADOW ? (To.compareFunction = 515,
    a = To) : a = wo,
...
function as(e, t) {
    let n = Po(t, this.size, 2);
    e.uniform2fv(this.addr, n)
}
function os(e, t) {
    let n = Po(t, this.size, 3);
    e.uniform3fv(this.addr, n)
}
function ss(e, t) {
    let n = Po(t, this.size, 4);
...
function ls(e, t) {
    let n = Po(t, this.size, 9);
    e.uniformMatrix3fv(this.addr, !1, n)
}
function us(e, t) {
    let n = Po(t, this.size, 16);
...
function ys(e, t, n) {
    let r = this.cache
      , i = t.length
      , a = Lo(n, i);
    Fo(r, a) || (e.uniform1iv(this.addr, a),
    Io(r, a));
    for (let e = 0; e !== i; ++e)
        n.setTexture2D(t[e] || wo, a[e])
}
function bs(e, t, n) {
    let r = this.cache
      , i = t.length
...
function Ss(e, t, n) {
    ...
    Io(r, a));
    for (let e = 0; e !== i; ++e)
        n.setTexture2DArray(t[e] || Eo, a[e])
}
function Cs(e) {
    switch (e) {
    case 5126:
...
function ks(e, t, n) {
    ...
    for (Ds.lastIndex = 0; ; ) {
        ...
        if (c && (s |= 0),
        l === void 0 || l === `[` && o + 2 === i) {
            Os(n, l === void 0 ? new ws(s,e,t) : new Ts(s,e,t));
            break
        }
        {
            let e = n.map[s];
...
var As = class {
    constructor(e, t) {
        ...
        for (let r = 0; r < n; ++r) {
            ...
            ks(n, e.getUniformLocation(t, n.name), this)
        }
    }
    setValue(e, t, n, r) {
        let i = this.map[t];
...
var Fs = new K;
function Is(e) {
    q._getMatrix(Fs, q.workingColorSpace, e);
    let t = `mat3( ${Fs.elements.map(e => e.toFixed(4))} )`;
...
var Bs = new Y;
function Vs() {
    return q.getLuminanceCoefficients(Bs),
    [`float luminance( const in vec3 rgb ) {`, `	const vec3 weights = vec3( ${Bs.x.toFixed(4)}, ${Bs.y.toFixed(4)}, ${Bs.z.toFixed(4)} );`, `	return dot( weights, rgb );`, `}`].join(`
`)
}
function Hs(e) {
...
function nc(e) {
    ...
    return e.shadowMapType === 1 ? t = `SHADOWMAP_TYPE_PCF` : e.shadowMapType === 2 ? t = `SHADOWMAP_TYPE_PCF_SOFT` : e.shadowMapType === 3 && (t = `SHADOWMAP_TYPE_VSM`),
    t
}
function rc(e) {
...
function sc(e, t, n, r) {
    let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = nc(n), l = rc(n), u = ic(n), d = ac(n), f = oc(n), p = Hs(n), m = Us(a), h = i.createProgram(), g, _, v = n.glslVersion ? `#version ` + n.glslVersion + `
` : ``;
...
` + _);
    let y = v + g + o
      , b = v + _ + s
      , x = js(i, i.VERTEX_SHADER, y)
      , S = js(i, i.FRAGMENT_SHADER, b);
    i.attachShader(h, x),
    i.attachShader(h, S),
...
` + r)
                ...
                n === `` ? (r === `` || a === ``) && (s = !1) : console.warn(`THREE.WebGLProgram: Program Info Log:`, n);
            s && (t.diagnostics = {
                runnable: o,
                programLog: n,
                vertexShader: {
    ...
    return this.isReady = function() {
        return E === !1 && (E = i.getProgramParameter(h, Ms)),
        E
    }
    ,
...
function dc(e, t, n, r, i, a, o) {
    ...
    function g(a, s, u, g, _) {
        let v = g.fog
          ...
          , C = m[a.type];
        a.precision !== null && (p = i.getMaxPrecision(a.precision),
        ...
        let j = e.getRenderTarget()
          ...
          , de = a.sheen > 0
          , fe = a.transmission > 0
          , z = se && !!a.anisotropyMap
          , pe = ce && !!a.clearcoatMap
          , B = ce && !!a.clearcoatNormalMap
          , me = ce && !!a.clearcoatRoughnessMap
          , V = ue && !!a.iridescenceMap
          , he = ue && !!a.iridescenceThicknessMap
          , H = de && !!a.sheenColorMap
          , U = de && !!a.sheenRoughnessMap
          , ge = !!a.specularMap
          , _e = !!a.specularColorMap
          , ve = !!a.specularIntensityMap
          , ye = fe && !!a.transmissionMap
          , be = fe && !!a.thicknessMap
          , xe = !!a.gradientMap
          , Se = !!a.alphaMap
          , Ce = a.alphaTest > 0
          , we = !!a.alphaHash
          , Te = !!a.extensions
          , Ee = 0;
        a.toneMapped && (j === null || j.isXRRenderTarget === !0) && (Ee = e.toneMapping);
        let De = {
            shaderID: C,
            shaderType: a.type,
            shaderName: a.name,
            ...
            outputColorSpace: j === null ? e.outputColorSpace : j.isXRRenderTarget === !0 ? j.texture.colorSpace : Ie,
            ...
            emissiveMap: R,
            normalMapObjectSpace: L && a.normalMapType === 1,
            normalMapTangentSpace: L && a.normalMapType === 0,
            metalnessMap: ae,
            roughnessMap: oe,
            anisotropy: se,
            anisotropyMap: z,
            ...
            aoMapUv: F && h(a.aoMap.channel),
            lightMapUv: re && h(a.lightMap.channel),
            bumpMapUv: I && h(a.bumpMap.channel),
            normalMapUv: L && h(a.normalMap.channel),
            displacementMapUv: ie && h(a.displacementMap.channel),
            emissiveMapUv: R && h(a.emissiveMap.channel),
            metalnessMapUv: ae && h(a.metalnessMap.channel),
            roughnessMapUv: oe && h(a.roughnessMap.channel),
            anisotropyMapUv: z && h(a.anisotropyMap.channel),
            clearcoatMapUv: pe && h(a.clearcoatMap.channel),
            clearcoatNormalMapUv: B && h(a.clearcoatNormalMap.channel),
            clearcoatRoughnessMapUv: me && h(a.clearcoatRoughnessMap.channel),
            iridescenceMapUv: V && h(a.iridescenceMap.channel),
            iridescenceThicknessMapUv: he && h(a.iridescenceThicknessMap.channel),
            sheenColorMapUv: H && h(a.sheenColorMap.channel),
            sheenRoughnessMapUv: U && h(a.sheenRoughnessMap.channel),
            ...
            transmissionMapUv: ye && h(a.transmissionMap.channel),
            thicknessMapUv: be && h(a.thicknessMap.channel),
            alphaMapUv: Se && h(a.alphaMap.channel),
            vertexTangents: !!y.attributes.tangent && (L || se),
            vertexColors: a.vertexColors,
            vertexAlphas: a.vertexColors === !0 && !!y.attributes.color && y.attributes.color.itemSize === 4,
            pointsUvs: _.isPoints === !0 && !!y.attributes.uv && (N || Se),
            fog: !!v,
            useFog: a.fog === !0,
            ...
            decodeVideoTextureEmissive: R && a.emissiveMap.isVideoTexture === !0 && q.getTransfer(a.emissiveMap.colorSpace) === `srgb`,
            ...
            extensionClipCullDistance: Te && a.extensions.clipCullDistance === !0 && r.has(`WEBGL_clip_cull_distance`),
            extensionMultiDraw: (Te && a.extensions.multiDraw === !0 || M) && r.has(`WEBGL_multi_draw`),
            rendererExtensionParallelShaderCompile: r.has(`KHR_parallel_shader_compile`),
            customProgramCacheKey: a.customProgramCacheKey()
        };
        return De.vertexUv1s = l.has(1),
        De.vertexUv2s = l.has(2),
        De.vertexUv3s = l.has(3),
        l.clear(),
        De
    }
    function _(t) {
        ...
        t.defines !== void 0)
            for (let e in t.defines)
                n.push(e),
                n.push(t.defines[e]);
        return t.isRawShaderMaterial === !1 && (v(n, t),
        y(n, t),
    ...
    function x(t, n) {
        ...
        return r === void 0 && (r = new sc(e,n,t,a),
        u.push(r)),
        r
    }
    function S(e) {
...
function hc() {
    ...
    function l(e, t) {
        n.length > 1 && n.sort(e || pc),
        r.length > 1 && r.sort(t || mc),
        i.length > 1 && i.sort(t || mc)
    }
    function u() {
...
function gc() {
    ...
    function t(t, n) {
        let r = e.get(t), i;
        return r === void 0 ? (i = new hc,
        e.set(t, [i])) : n >= r.length ? (i = new hc,
        r.push(i)) : i = r[n],
        i
    }
    function n() {
...
function xc(e) {
    ...
    function s(i) {
        ...
        d > 0 && (e.has(`OES_texture_float_linear`) === !0 ? (r.rectAreaLTC1 = Q.LTC_FLOAT_1,
        r.rectAreaLTC2 = Q.LTC_FLOAT_2) : (r.rectAreaLTC1 = Q.LTC_HALF_1,
        r.rectAreaLTC2 = Q.LTC_HALF_2)),
        r.ambient[0] = a,
        r.ambient[1] = o,
        r.ambient[2] = s;
        let y = r.hash;
...
function Cc(e) {
    ...
    function n(n, r=0) {
        let i = t.get(n), a;
        return i === void 0 ? (a = new Sc(e),
        t.set(n, [a])) : r >= i.length ? (a = new Sc(e),
        i.push(a)) : a = i[r],
        a
    }
    function r() {
...
function Ec(e, t, n) {
    ...
    let h = new Er;
    h.setAttribute(`position`, new hr(new Float32Array([-1, -1, .5, 3, -1, .5, -1, 3, .5]),3));
    let g = new Rr(h,p)
      , _ = this;
    this.enabled = !1,
    this.autoUpdate = !0,
    ...
    this.render = function(t, n, s) {
        ...
        for (let c = 0, u = t.length; c < u; c++) {
            ...
            if (i.multiply(g),
            a.copy(f.mapSize),
            (i.x > d || i.y > d) && (i.x > d && (a.x = Math.floor(d / g.x),
            i.x = a.x * g.x,
            f.mapSize.x = a.x),
            i.y > d && (a.y = Math.floor(d / g.y),
            i.y = a.y * g.y,
            f.mapSize.y = a.y)),
            f.map === null || m === !0 || h === !0) {
                let e = this.type === 3 ? {} : {
            ...
            for (let e = 0; e < _; e++) {
                ...
                r = f.getFrustum(),
                x(n, s, f.camera, u, this.type)
            }
            f.isPointLightShadow !== !0 && this.type === 3 && y(f, s),
            f.needsUpdate = !1
        }
        v = this.type,
        _.needsUpdate = !1,
        e.setRenderTarget(c, u, f)
    }
    ;
    function y(n, r) {
        let a = t.update(g);
        ...
        p.needsUpdate = !0,
        m.needsUpdate = !0),
        n.mapPass === null && (n.mapPass = new Lt(i.x,i.y)),
    ...
    function b(t, n, r, i) {
        ...
        if (o !== void 0)
            a = o;
        else if (a = r.isPointLight === !0 ? c : s,
        e.localClippingEnabled && n.clipShadows === !0 && Array.isArray(n.clippingPlanes) && n.clippingPlanes.length !== 0 || n.displacementMap && n.displacementScale !== 0 || n.alphaMap && n.alphaTest > 0 || n.map && n.alphaTest > 0) {
            let e = a.uuid
              , t = n.uuid
              , r = u[e];
            r === void 0 && (r = {},
        ...
        i === 3 ? a.side = n.shadowSide === null ? n.side : n.shadowSide : a.side = n.shadowSide === null ? f[n.side] : n.shadowSide,
...
function Oc(e, t) {
        ...
        return {
            setReversed: function(e) {
                if (r !== e) {
                    ...
                    r ? e.clipControlEXT(e.LOWER_LEFT_EXT, e.ZERO_TO_ONE_EXT) : e.clipControlEXT(e.LOWER_LEFT_EXT, e.NEGATIVE_ONE_TO_ONE_EXT);
                    let n = o;
                    o = null,
                    this.setClear(n)
                }
            ...
            setTest: function(t) {
                t ? R(e.DEPTH_TEST) : ae(e.DEPTH_TEST)
            },
            setMask: function(t) {
                i !== t && !n && (e.depthMask(t),
                i = t)
    ...
    function i() {
        ...
        return {
            setTest: function(n) {
                t || (n ? R(e.STENCIL_TEST) : ae(e.STENCIL_TEST))
            },
            setMask: function(r) {
    ...
    M.indexOf(`WebGL`) === -1 ? M.indexOf(`OpenGL ES`) !== -1 && (te = parseFloat(/^OpenGL ES (\d)/.exec(M)[1]),
    ee = te >= 2) : (te = parseFloat(/^WebGL (\d)/.exec(M)[1]),
    ee = te >= 1);
    let N = null
      , P = {}
      , ne = e.getParameter(e.SCISSOR_BOX)
      , F = e.getParameter(e.VIEWPORT)
      , re = new J().fromArray(ne)
      , I = new J().fromArray(F);
    function L(t, n, r, i) {
    ...
    let ie = {};
    ie[e.TEXTURE_2D] = L(e.TEXTURE_2D, e.TEXTURE_2D, 1),
    ie[e.TEXTURE_CUBE_MAP] = L(e.TEXTURE_CUBE_MAP, e.TEXTURE_CUBE_MAP_POSITIVE_X, 6),
    ie[e.TEXTURE_2D_ARRAY] = L(e.TEXTURE_2D_ARRAY, e.TEXTURE_2D_ARRAY, 1, 1),
    ie[e.TEXTURE_3D] = L(e.TEXTURE_3D, e.TEXTURE_3D, 1, 1),
    a.setClear(0, 0, 0, 1),
    o.setClear(1),
    s.setClear(0),
    R(e.DEPTH_TEST),
    ...
    function de(t, n, r, i, a, o, s, c, l, u) {
        ...
        o ||= r,
        s ||= i,
        (n !== _ || a !== b) && (e.blendEquationSeparate(le[n], le[a]),
        _ = n,
        b = a),
        (r !== v || i !== y || o !== x || s !== S) && (e.blendFuncSeparate(ue[r], ue[i], ue[o], ue[s]),
        v = r,
        y = i,
        x = o,
        S = s),
    ...
    function fe(t, n) {
        t.side === 2 ? ae(e.CULL_FACE) : R(e.CULL_FACE);
        let r = t.side === 1;
        n && (r = !r),
        z(r),
        t.blending === 1 && t.transparent === !1 ? de(0) : de(t.blending, t.blendEquation, t.blendSrc, t.blendDst, t.blendEquationAlpha, t.blendSrcAlpha, t.blendDstAlpha, t.blendColor, t.blendAlpha, t.premultipliedAlpha),
        ...
        me(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits),
        t.alphaToCoverage === !0 ? R(e.SAMPLE_ALPHA_TO_COVERAGE) : ae(e.SAMPLE_ALPHA_TO_COVERAGE)
    }
    function z(t) {
    ...
    function pe(t) {
        t === 0 ? ae(e.CULL_FACE) : (R(e.CULL_FACE),
        t !== D && (t === 1 ? e.cullFace(e.BACK) : t === 2 ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))),
        D = t
    }
    function B(t) {
        t !== O && (ee && e.lineWidth(t),
        O = t)
    }
    function me(t, n, r) {
        t ? (R(e.POLYGON_OFFSET_FILL),
        (k !== n || A !== r) && (e.polygonOffset(n, r),
        k = n,
        A = r)) : ae(e.POLYGON_OFFSET_FILL)
    }
    function V(t) {
        t ? R(e.SCISSOR_TEST) : ae(e.SCISSOR_TEST)
    }
    function he(t) {
    ...
    function H(t, n, r) {
        ...
        P[r] = i),
        (i.type !== t || i.texture !== n) && (N !== r && (e.activeTexture(r),
        N = r),
    ...
    function Ee(t) {
        re.equals(t) === !1 && (e.scissor(t.x, t.y, t.z, t.w),
        re.copy(t))
    }
    function De(t) {
        I.equals(t) === !1 && (e.viewport(t.x, t.y, t.z, t.w),
        I.copy(t))
    }
    function Oe(t, n) {
        let r = l.get(n);
...
function kc(e, t, n, r, i, a, h) {
    let g = t.has(`WEBGL_multisampled_render_to_texture`) ? t.get(`WEBGL_multisampled_render_to_texture`) : null, _ = typeof navigator > `u` ? !1 : /OculusBrowser/g.test(navigator.userAgent), v = new G, y = new WeakMap, b, x = new WeakMap, S = !1;
    try {
        S = typeof OffscreenCanvas < `u` && new OffscreenCanvas(1,1).getContext(`2d`) !== null
    } catch {}
    function C(e, t) {
        return S ? new OffscreenCanvas(e,t) : _t(`canvas`)
    }
    function w(e, t, n) {
        let r = 1
          , i = Se(e);
        ...
        r < 1)
            if (typeof HTMLImageElement < `u` && e instanceof HTMLImageElement || typeof HTMLCanvasElement < `u` && e instanceof HTMLCanvasElement || typeof ImageBitmap < `u` && e instanceof ImageBitmap || typeof VideoFrame < `u` && e instanceof VideoFrame) {
                ...
                console.warn(`THREE.WebGLRenderer: Texture has been resized from (` + i.width + `x` + i.height + `) to (` + n + `x` + a + `).`),
                o
            } else
    ...
    function k(t, n) {
        ...
        console.warn(`DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.`)) : n === null || n === 1014 || n === 1020 ? r = e.DEPTH_COMPONENT24 : n === 1015 ? r = e.DEPTH_COMPONENT32F : n === 1012 && (r = e.DEPTH_COMPONENT16),
        r
    }
    function A(e, t) {
    ...
    function M(e) {
        ...
        if (i) {
            ...
            r.usedTimes--,
            r.usedTimes === 0 && N(e),
            Object.keys(i).length === 0 && x.delete(n)
        }
        r.remove(e)
    }
    function N(t) {
    ...
    function L(t, i) {
        let a = r.get(t);
        if (t.isVideoTexture && be(t),
        t.isRenderTargetTexture === !1 && t.version > 0 && a.__version !== t.version) {
            let e = t.image;
            if (e === null)
    ...
    function le(n, a) {
        if (a.type === 1015 && t.has(`OES_texture_float_linear`) === !1 && (a.magFilter === 1006 || a.magFilter === 1007 || a.magFilter === 1005 || a.magFilter === 1008 || a.minFilter === 1006 || a.minFilter === 1007 || a.minFilter === 1005 || a.minFilter === 1008) && console.warn(`THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device.`),
        e.texParameteri(n, e.TEXTURE_WRAP_S, oe[a.wrapS]),
        e.texParameteri(n, e.TEXTURE_WRAP_T, oe[a.wrapT]),
        (n === e.TEXTURE_3D || n === e.TEXTURE_2D_ARRAY) && e.texParameteri(n, e.TEXTURE_WRAP_R, oe[a.wrapR]),
        e.texParameteri(n, e.TEXTURE_MAG_FILTER, se[a.magFilter]),
        e.texParameteri(n, e.TEXTURE_MIN_FILTER, se[a.minFilter]),
        a.compareFunction && (e.texParameteri(n, e.TEXTURE_COMPARE_MODE, e.COMPARE_REF_TO_TEXTURE),
        e.texParameteri(n, e.TEXTURE_COMPARE_FUNC, ce[a.compareFunction])),
        t.has(`EXT_texture_filter_anisotropic`) === !0) {
            if (a.magFilter === 1003 || a.minFilter !== 1005 && a.minFilter !== 1008 || a.type === 1015 && t.has(`OES_texture_float_linear`) === !1)
                return;
    ...
    function ue(t, n) {
        ...
        if (o !== t.__cacheKey) {
            ...
            i !== void 0 && (a[t.__cacheKey].usedTimes--,
            i.usedTimes === 0 && N(n)),
            t.__cacheKey = o,
    ...
    function de(t, o, s) {
        ...
        if (u.version !== d.__version || l === !0) {
            ...
            let t = q.getPrimaries(q.workingColorSpace)
              , r = o.colorSpace === `` ? null : q.getPrimaries(o.colorSpace)
            ...
            le(c, o);
            let _, v = o.mipmaps, y = o.isVideoTexture !== !0, b = d.__version === void 0 || l === !0, x = u.dataReady, S = A(o, p);
            if (o.isDepthTexture)
                g = k(o.format === te, o.type),
                b && (y ? n.texStorage2D(e.TEXTURE_2D, 1, g, p.width, p.height) : n.texImage2D(e.TEXTURE_2D, 0, g, p.width, p.height, 0, m, h, null));
            else if (o.isDataTexture)
                if (v.length > 0) {
                    y && b && n.texStorage2D(e.TEXTURE_2D, S, g, v[0].width, v[0].height);
                    for (let t = 0, r = v.length; t < r; t++)
                        _ = v[t],
                        y ? x && n.texSubImage2D(e.TEXTURE_2D, t, 0, 0, _.width, _.height, m, h, _.data) : n.texImage2D(e.TEXTURE_2D, t, g, _.width, _.height, 0, m, h, _.data);
                    o.generateMipmaps = !1
                } else
                    y ? (b && n.texStorage2D(e.TEXTURE_2D, S, g, p.width, p.height),
                    x && n.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, p.width, p.height, m, h, p.data)) : n.texImage2D(e.TEXTURE_2D, 0, g, p.width, p.height, 0, m, h, p.data);
                                ...
                                if (y) {
                                    if (x)
                                        if (o.layerUpdates.size > 0) {
                                            let r = Ia(_.width, _.height, o.format, o.type);
                                            for (let i of o.layerUpdates) {
                                                let a = _.data.subarray(i * r / _.data.BYTES_PER_ELEMENT, (i + 1) * r / _.data.BYTES_PER_ELEMENT);
                                                n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY, t, 0, 0, i, _.width, _.height, 1, m, a)
                                            }
                                            o.clearLayerUpdates()
                                        } else
                                            n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY, t, 0, 0, 0, _.width, _.height, p.depth, m, _.data)
                                } else
                                    n.compressedTexImage3D(e.TEXTURE_2D_ARRAY, t, g, _.width, _.height, p.depth, 0, _.data, 0, 0);
                            else
                                console.warn(`THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()`);
                        else
                            y ? x && n.texSubImage3D(e.TEXTURE_2D_ARRAY, t, 0, 0, 0, _.width, _.height, p.depth, m, h, _.data) : n.texImage3D(e.TEXTURE_2D_ARRAY, t, g, _.width, _.height, p.depth, 0, m, h, _.data)
                } else {
                    y && b && n.texStorage2D(e.TEXTURE_2D, S, g, v[0].width, v[0].height);
                    for (let t = 0, r = v.length; t < r; t++)
                        _ = v[t],
                        o.format === 1023 ? y ? x && n.texSubImage2D(e.TEXTURE_2D, t, 0, 0, _.width, _.height, m, h, _.data) : n.texImage2D(e.TEXTURE_2D, t, g, _.width, _.height, 0, m, h, _.data) : m === null ? console.warn(`THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()`) : y ? x && n.compressedTexSubImage2D(e.TEXTURE_2D, t, 0, 0, _.width, _.height, m, _.data) : n.compressedTexImage2D(e.TEXTURE_2D, t, g, _.width, _.height, 0, _.data)
                }
            else if (o.isDataArrayTexture)
                if (y) {
                    if (b && n.texStorage3D(e.TEXTURE_2D_ARRAY, S, g, p.width, p.height, p.depth),
                    x)
                        if (o.layerUpdates.size > 0) {
                            let t = Ia(p.width, p.height, o.format, o.type);
                            ...
                            n.texSubImage3D(e.TEXTURE_2D_ARRAY, 0, 0, 0, 0, p.width, p.height, p.depth, m, h, p.data)
                } else
                    n.texImage3D(e.TEXTURE_2D_ARRAY, 0, g, p.width, p.height, p.depth, 0, m, h, p.data);
            else if (o.isData3DTexture)
                y ? (b && n.texStorage3D(e.TEXTURE_3D, S, g, p.width, p.height, p.depth),
                x && n.texSubImage3D(e.TEXTURE_3D, 0, 0, 0, 0, p.width, p.height, p.depth, m, h, p.data)) : n.texImage3D(e.TEXTURE_3D, 0, g, p.width, p.height, p.depth, 0, m, h, p.data);
            else if (o.isFramebufferTexture) {
                if (b)
                    if (y)
                        n.texStorage2D(e.TEXTURE_2D, S, g, p.width, p.height);
                    else {
                        let t = p.width
                          , r = p.height;
                        for (let i = 0; i < S; i++)
                            n.texImage2D(e.TEXTURE_2D, i, g, t, r, 0, m, h, null),
                            t >>= 1,
                            r >>= 1
                    }
            } else if (v.length > 0) {
                ...
                for (let t = 0, r = v.length; t < r; t++)
                    _ = v[t],
                    y ? x && n.texSubImage2D(e.TEXTURE_2D, t, 0, 0, m, h, _) : n.texImage2D(e.TEXTURE_2D, t, g, m, h, _);
                o.generateMipmaps = !1
            } else if (y) {
                if (b) {
                    let t = Se(p);
                ...
                n.texImage2D(e.TEXTURE_2D, 0, g, m, h, p);
            T(o) && E(c),
    ...
    function fe(t, o, s) {
        ...
        if (l.version !== u.__version || c === !0) {
            ...
            let f = o.isCompressedTexture || o.image[0].isCompressedTexture
              ...
              , m = [];
            for (let e = 0; e < 6; e++)
                !f && !p ? m[e] = w(o.image[e], !0, i.maxCubemapSize) : m[e] = p ? o.image[e].image : o.image[e],
                m[e] = xe(o, m[e]);
            let h = m[0]
            ...
            T(o) && E(e.TEXTURE_CUBE_MAP),
            u.__version = l.version,
            o.onUpdate && o.onUpdate(o)
        }
        t.__version = o.version
    }
    function z(t, i, o, s, c, l) {
        let u = a.convert(o.format, o.colorSpace)
          , d = a.convert(o.type)
          , f = O(o.internalFormat, u, d, o.colorSpace)
          , p = r.get(i)
          , m = r.get(o);
        if (m.__renderTarget = i,
        !p.__hasExternalTextures) {
            let t = Math.max(1, i.width >> l)
              , r = Math.max(1, i.height >> l);
        ...
        ye(i) ? g.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, s, c, m.__webglTexture, 0, ve(i)) : (c === e.TEXTURE_2D || c >= e.TEXTURE_CUBE_MAP_POSITIVE_X && c <= e.TEXTURE_CUBE_MAP_NEGATIVE_Z) && e.framebufferTexture2D(e.FRAMEBUFFER, s, c, m.__webglTexture, l),
    ...
    function pe(t, n, r) {
        ...
        n.depthBuffer) {
            let i = n.depthTexture
              ...
              , c = ve(n);
            ye(n) ? g.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, c, o, n.width, n.height) : r ? e.renderbufferStorageMultisample(e.RENDERBUFFER, c, o, n.width, n.height) : e.renderbufferStorage(e.RENDERBUFFER, o, n.width, n.height),
            ...
            for (let i = 0; i < t.length; i++) {
                let o = t[i]
                  ...
                  , c = a.convert(o.type)
                  , l = O(o.internalFormat, s, c, o.colorSpace)
                  , u = ve(n);
                r && ye(n) === !1 ? e.renderbufferStorageMultisample(e.RENDERBUFFER, u, l, n.width, n.height) : ye(n) ? g.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, u, l, n.width, n.height) : e.renderbufferStorage(e.RENDERBUFFER, l, n.width, n.height)
            }
        }
    ...
    function B(t, i) {
        ...
        if (i.depthTexture.format === 1026)
            ye(i) ? g.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, e.DEPTH_ATTACHMENT, e.TEXTURE_2D, o, 0, s) : e.framebufferTexture2D(e.FRAMEBUFFER, e.DEPTH_ATTACHMENT, e.TEXTURE_2D, o, 0);
        else if (i.depthTexture.format === 1027)
            ye(i) ? g.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, e.DEPTH_STENCIL_ATTACHMENT, e.TEXTURE_2D, o, 0, s) : e.framebufferTexture2D(e.FRAMEBUFFER, e.DEPTH_STENCIL_ATTACHMENT, e.TEXTURE_2D, o, 0);
        else
    ...
    function V(t, n, i) {
        let a = r.get(t);
        n !== void 0 && z(a.__webglFramebuffer, t, t.texture, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, 0),
        i !== void 0 && me(t)
    }
    function he(t) {
        let i = t.texture
        ...
        let c = t.textures
          , l = t.isWebGLCubeRenderTarget === !0
          , u = c.length > 1;
        if (u || (s.__webglTexture === void 0 && (s.__webglTexture = e.createTexture()),
        ...
        l) {
            ...
            if (u)
                for (let t = 0, n = c.length; t < n; t++) {
                    let n = r.get(c[t]);
                    n.__webglTexture === void 0 && (n.__webglTexture = e.createTexture(),
                    h.memory.textures++)
                }
            if (t.samples > 0 && ye(t) === !1) {
                ...
                for (let n = 0; n < c.length; n++) {
                    ...
                    let i = a.convert(r.format, r.colorSpace)
                      , s = a.convert(r.type)
                      , l = O(r.internalFormat, i, s, r.colorSpace, t.isXRRenderTarget === !0)
                      , u = ve(t);
                ...
                pe(o.__webglDepthRenderbuffer, t, !0)),
                n.bindFramebuffer(e.FRAMEBUFFER, null)
            }
        }
        if (l) {
            n.bindTexture(e.TEXTURE_CUBE_MAP, s.__webglTexture),
            le(e.TEXTURE_CUBE_MAP, i);
            for (let n = 0; n < 6; n++)
                if (i.mipmaps && i.mipmaps.length > 0)
                    for (let r = 0; r < i.mipmaps.length; r++)
                        z(o.__webglFramebuffer[n][r], t, i, e.COLOR_ATTACHMENT0, e.TEXTURE_CUBE_MAP_POSITIVE_X + n, r);
                else
                    z(o.__webglFramebuffer[n], t, i, e.COLOR_ATTACHMENT0, e.TEXTURE_CUBE_MAP_POSITIVE_X + n, 0);
            T(i) && E(e.TEXTURE_CUBE_MAP),
            n.unbindTexture()
        } else if (u) {
            for (let i = 0, a = c.length; i < a; i++) {
                ...
                le(e.TEXTURE_2D, a),
                z(o.__webglFramebuffer, t, a, e.COLOR_ATTACHMENT0 + i, e.TEXTURE_2D, 0),
                T(a) && E(e.TEXTURE_2D)
            }
            n.unbindTexture()
        } else {
            ...
            i.mipmaps && i.mipmaps.length > 0)
                for (let n = 0; n < i.mipmaps.length; n++)
                    z(o.__webglFramebuffer[n], t, i, e.COLOR_ATTACHMENT0, r, n);
            else
                z(o.__webglFramebuffer, t, i, e.COLOR_ATTACHMENT0, r, 0);
            T(i) && E(r),
            n.unbindTexture()
        }
        t.depthBuffer && me(t)
            ...
            if (ye(t) === !1) {
                ...
                if (u)
                    for (let t = 0; t < i.length; t++)
                        n.bindFramebuffer(e.FRAMEBUFFER, l.__webglMultisampledFramebuffer),
                ...
                n.bindFramebuffer(e.DRAW_FRAMEBUFFER, l.__webglFramebuffer);
                for (let n = 0; n < i.length; n++) {
                    ...
                    _ === !0 && (U.length = 0,
                    ge.length = 0,
                    U.push(e.COLOR_ATTACHMENT0 + n),
                    t.depthBuffer && t.resolveDepthBuffer === !1 && (U.push(c),
                    ge.push(c),
                    e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, ge)),
                ...
                u)
                    for (let t = 0; t < i.length; t++) {
                        n.bindFramebuffer(e.FRAMEBUFFER, l.__webglMultisampledFramebuffer),
                        e.framebufferRenderbuffer(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0 + t, e.RENDERBUFFER, l.__webglColorRenderbuffer[t]);
    ...
    function xe(e, t) {
        let n = e.colorSpace
          , r = e.format
          , i = e.type;
        return e.isCompressedTexture === !0 || e.isVideoTexture === !0 || n !== `srgb-linear` && n !== `` && (q.getTransfer(n) === `srgb` ? (r !== 1023 || i !== 1009) && console.warn(`THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.`) : console.error(`THREE.WebGLTextures: Unsupported texture color space:`, n)),
        t
    }
    function Se(e) {
...
var jc = {
  ...
  , Mc = class {
    ...
    getHandSpace() {
        return this._hand === null && (this._hand = new Oi,
    ...
    getTargetRaySpace() {
        return this._targetRay === null && (this._targetRay = new Oi,
    ...
    getGripSpace() {
        return this._grip === null && (this._grip = new Oi,
    ...
    update(e, t, n) {
        ...
        if (e && t.session.visibilityState !== `visible-blurred`) {
            if (c && e.hand) {
                ...
                c.inputState.pinching && o > .025 ? (c.inputState.pinching = !1,
                this.dispatchEvent({
                    type: `pinchend`,
                    handedness: e.handedness,
                    target: this
                })) : !c.inputState.pinching && o <= .015 && (c.inputState.pinching = !0,
                this.dispatchEvent({
                    type: `pinchstart`,
                    handedness: e.handedness,
                    target: this
  ...
  , Fc = class {
    ...
    getMesh(e) {
        if (this.texture !== null && this.mesh === null) {
            ...
            this.mesh = new Rr(new Ri(20,20),n)
        }
        return this.mesh
    }
    reset() {
  ...
  , Ic = class extends He {
    constructor(e, t) {
        ...
        this.setSession = async function(l) {
            ...
            r !== null) {
                ...
                r.renderState.layers === void 0) {
                    ...
                    v = new Lt(f.framebufferWidth,f.framebufferHeight,{
                        format: k,
                        type: h,
                    ...
                    let n = null
                      , a = null
                      , o = null;
                    g.depth && (o = g.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24,
                    n = g.stencil ? te : ee,
                    a = g.stencil ? T : b);
                    let s = {
                        colorFormat: t.RGBA8,
                    ...
                    v = new Lt(d.textureWidth,d.textureHeight,{
                        format: k,
                        type: h,
                        depthTexture: new Ai(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),
                        stencilBuffer: g.stencil,
                        colorSpace: e.outputColorSpace,
        ...
        this.updateCamera = function(e) {
            ...
            let t = e.near
              , n = e.far;
            m.texture !== null && (m.depthNear > 0 && (t = m.depthNear),
            m.depthFar > 0 && (n = m.depthFar)),
            O.near = E.near = w.near = t,
            O.far = E.far = w.far = n,
            (A !== O.near || j !== O.far) && (r.updateRenderState({
                depthNear: O.near,
                depthFar: O.far
            }),
            A = O.near,
            j = O.far),
            w.layers.mask = e.layers.mask | 2,
            E.layers.mask = e.layers.mask | 4,
            O.layers.mask = w.layers.mask | E.layers.mask;
            let i = e.parent
              , a = O.cameras;
            I(O, i);
            for (let e = 0; e < a.length; e++)
                I(a[e], i);
            a.length === 2 ? re(O, w, E) : O.projectionMatrix.copy(w.projectionMatrix),
            L(e, O, i)
        }
        ;
        function L(e, t, n) {
            ...
            e.projectionMatrix.copy(t.projectionMatrix),
            e.projectionMatrixInverse.copy(t.projectionMatrixInverse),
            e.isPerspectiveCamera && (e.fov = Ke * 2 * Math.atan(1 / e.projectionMatrix.elements[5]),
            e.zoom = 1)
        }
        ...
        function R(t, i) {
            ...
            l !== null) {
                let t = l.views;
                f !== null && (e.setRenderTargetFramebuffer(v, f.framebuffer),
                e.setRenderTarget(v));
                let n = !1;
                ...
                for (let r = 0; r < t.length; r++) {
                    ...
                    if (f !== null)
                        ...
                        a = t.viewport,
                        r === 0 && (e.setRenderTargetTextures(v, t.colorTexture, d.ignoreDepthValues ? void 0 : t.depthStencilTexture),
                        e.setRenderTarget(v))
                    }
                    let o = D[r];
                    o === void 0 && (o = new ei,
                    ...
                    r === 0 && (O.matrix.copy(o.matrix),
                    O.matrix.decompose(O.position, O.quaternion, O.scale)),
                    n === !0 && O.cameras.push(o)
                }
...
function zc(e, t) {
    ...
    function r(t, n) {
        n.color.getRGB(t.fogColor.value, Gr(e)),
        n.isFog ? (t.fogNear.value = n.near,
        t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density)
    }
    function i(e, t, n, r, i) {
        t.isMeshBasicMaterial || t.isMeshLambertMaterial ? a(e, t) : t.isMeshToonMaterial ? (a(e, t),
        d(e, t)) : t.isMeshPhongMaterial ? (a(e, t),
        u(e, t)) : t.isMeshStandardMaterial ? (a(e, t),
        f(e, t),
    ...
    function a(e, r) {
        ...
        Lc.y *= -1,
        Lc.z *= -1,
        a.isCubeTexture && a.isRenderTargetTexture === !1 && (Lc.y *= -1,
        Lc.z *= -1),
        e.envMapRotation.value.setFromMatrix4(Rc.makeRotationFromEuler(Lc)),
...
function Bc(e, t, n, r) {
    ...
    function p(e, t, n, r) {
        let i = e.value
          , a = t + `_` + n;
        if (r[a] === void 0)
            return r[a] = typeof i == `number` || typeof i == `boolean` ? i : i.clone(),
            !0;
        {
            let e = r[a];
...
var Vc = class {
    constructor(e={}) {
        let {canvas: t=vt(), context: n=null, depth: r=!0, stencil: i=!1, alpha: a=!1, antialias: o=!1, premultipliedAlpha: s=!0, preserveDrawingBuffer: c=!1, powerPreference: l=`default`, failIfMajorPerformanceCaveat: u=!1, reverseDepthBuffer: d=!1} = e;
        ...
        try {
            ...
            if (`setAttribute` in t && t.setAttribute(`data-engine`, `three.js r171`),
            ...
            z === null) {
                ...
                if (z = pe(t, e),
                z === null)
                    throw pe(t) ? Error(`Error creating WebGL context with your selected attributes.`) : Error(`Error creating WebGL context.`)
            }
        } catch (e) {
            throw console.error(`THREE.WebGLRenderer: ` + e.message),
            e
        }
        let B, me, V, he, H, U, ge, _e, ve, ye, be, xe, Se, Ce, we, Te, Ee, De, Oe, ke, Ae, je, Me, Ne;
        function Pe() {
            B = new vo(z),
            B.init(),
            je = new Ac(z,B),
            me = new qa(z,B,e,je),
            V = new Oc(z,B),
            me.reverseDepthBuffer && d && V.buffers.depth.setReversed(!0),
            he = new xo(z),
            H = new fc,
            U = new kc(z,B,V,H,me,je,he),
            ge = new Ya(x),
            _e = new _o(x),
            ve = new za(z),
            Me = new Ga(z,ve),
            ye = new yo(z,ve,he,Me),
            be = new Co(z,ye,ve,he),
            Oe = new So(z,me,U),
            Te = new Ja(H),
            xe = new dc(x,ge,_e,B,me,Me,Te),
            Se = new zc(x,H),
            Ce = new gc,
            we = new Cc(B),
            De = new Wa(x,ge,_e,V,be,f,s),
            Ee = new Ec(x,be,me),
            Ne = new Bc(z,he,me,V),
            ke = new Ka(z,B,he),
            Ae = new bo(z,B,he),
            he.programs = xe.programs,
            x.capabilities = me,
            x.extensions = B,
            x.properties = H,
            x.renderLists = Ce,
        ...
        this.setViewport = function(e, t, n, r) {
            e.isVector4 ? re.set(e.x, e.y, e.z, e.w) : re.set(e, t, n, r),
            V.viewport(k.copy(re).multiplyScalar(P).round())
        }
        ,
        ...
        this.setScissor = function(e, t, n, r) {
            ...
            V.scissor(A.copy(I).multiplyScalar(P).round())
        }
        ,
        ...
        this.clear = function(e=!0, t=!0, n=!0) {
            ...
            if (e) {
                ...
                if (e) {
                    ...
                    p[2] = o,
                    p[3] = r,
                    z.clearBufferuiv(z.COLOR, 0, p)) : (g[0] = i,
                    g[1] = a,
                    g[2] = o,
                    g[3] = r,
                    z.clearBufferiv(z.COLOR, 0, g))
                } else
                    r |= z.COLOR_BUFFER_BIT
            }
            t && (r |= z.DEPTH_BUFFER_BIT),
            n && (r |= z.STENCIL_BUFFER_BIT,
        ...
        this.dispose = function() {
            ...
            xe.dispose(),
            Le.dispose(),
            Le.removeEventListener(`sessionstart`, qe),
            Le.removeEventListener(`sessionend`, W),
            Je.stop()
        }
        ;
        function Re(e) {
        ...
        this.renderBufferDirect = function(e, t, n, r, i, a) {
            ...
            let c = n.index
              , l = 1;
            if (r.wireframe === !0) {
                if (c = ye.getWireframeAttribute(n),
                c === void 0)
                    return;
                l = 2
            }
            ...
            Me.setup(i, r, s, n, c);
            let h, g = ke;
            if (c !== null && (h = ve.get(c),
            g = Ae,
            g.setIndex(h)),
            i.isMesh)
                r.wireframe === !0 ? (V.setLineWidth(r.wireframeLinewidth * fe()),
                g.setMode(z.LINES)) : g.setMode(z.TRIANGLES);
            else if (i.isLine) {
                let e = r.linewidth;
                e === void 0 && (e = 1),
                V.setLineWidth(e * fe()),
                i.isLineSegments ? g.setMode(z.LINES) : i.isLineLoop ? g.setMode(z.LINE_LOOP) : g.setMode(z.LINE_STRIP)
            } else
                i.isPoints ? g.setMode(z.POINTS) : i.isSprite && g.setMode(z.TRIANGLES);
            if (i.isBatchedMesh)
        ...
        let Je = new Ra;
        Je.setAnimationLoop(Ke),
        typeof self < `u` && Je.setContext(self),
        this.setAnimationLoop = function(e) {
            Ge = e,
            Le.setAnimationLoop(e),
            e === null ? Je.stop() : Je.start()
        }
        ,
        Le.addEventListener(`sessionstart`, qe),
        Le.addEventListener(`sessionend`, W),
        this.render = function(e, t) {
            ...
            Le.enabled === !0 && Le.isPresenting === !0 && (Le.cameraAutoUpdate === !0 && Le.updateCamera(t),
            t = Le.getCamera()),
            ...
            R = Te.init(this.clippingPlanes, ae),
            _ = Ce.get(e, y.length),
            _.init(),
            y.push(_),
            Le.enabled === !0 && Le.isPresenting === !0) {
                let e = x.xr.getDepthSensingMesh();
                e !== null && Ye(e, t, -1 / 0, x.sortObjects)
            }
            Ye(e, t, 0, x.sortObjects),
            _.finish(),
            x.sortObjects === !0 && _.sort(ne, F),
            de = Le.enabled === !1 || Le.isPresenting === !1 || Le.hasDepthSensing() === !1,
            de && De.addToRenderList(_, e),
            ...
            t.isArrayCamera) {
                ...
                i.length > 0 && Ze(r, i, e, t),
                de && De.render(e),
                Xe(_, e, t);
            E !== null && (U.updateMultisampleRenderTarget(E),
            U.updateRenderTargetMipmap(E)),
            e.isScene === !0 && e.onAfterRender(x, e, t),
            Me.resetDefaultState(),
            D = -1,
            O = null,
            b.pop(),
            b.length > 0 ? (v = b[b.length - 1],
            R === !0 && Te.setGlobalState(x.clippingPlanes, v.state.camera)) : v = null,
            y.pop(),
            ...
            if (e.layers.test(t.layers)) {
                if (e.isGroup)
                    ...
                    if (!e.frustumCulled || ie.intersectsSprite(e)) {
                        ...
                        let t = be.update(e)
                          , i = e.material;
                        i.visible && _.push(e, t, i, n, le.z, null)
                    }
                    ...
                    le.copy(t.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(),
                    ...
                    Array.isArray(i)) {
                        ...
                        for (let a = 0, o = r.length; a < o; a++) {
                            let o = r[a]
                              , s = i[o.materialIndex];
                            s && s.visible && _.push(e, t, s, n, le.z, o)
                        }
                    } else
                        i.visible && _.push(e, t, i, n, le.z, null)
                }
        ...
        function Xe(e, t, n, r) {
            let i = e.opaque
              ...
              , o = e.transparent;
            v.setupLightsView(n),
            R === !0 && Te.setGlobalState(x.clippingPlanes, n),
            r && V.viewport(k.copy(r)),
            i.length > 0 && Qe(i, t, n),
            a.length > 0 && Qe(a, t, n),
            o.length > 0 && Qe(o, t, n),
        ...
        function Ze(e, t, n, r) {
            if ((n.isScene === !0 ? n.overrideMaterial : null) !== null)
                return;
            v.state.transmissionRenderTarget[r.id] === void 0 && (v.state.transmissionRenderTarget[r.id] = new Lt(1,1,{
                generateMipmaps: !0,
                type: B.has(`EXT_color_buffer_half_float`) || B.has(`EXT_color_buffer_float`) ? S : h,
                minFilter: m,
                samples: 4,
                stencilBuffer: i,
            ...
            x.getClearColor(ee),
            te = x.getClearAlpha(),
            te < 1 && x.setClearColor(16777215, .5),
            x.clear(),
            de && De.render(n);
            let c = x.toneMapping;
            x.toneMapping = 0;
            ...
            v.setupLightsView(r),
            R === !0 && Te.setGlobalState(x.clippingPlanes, r),
            Qe(e, n, r),
            ...
            B.has(`WEBGL_multisampled_render_to_texture`) === !1) {
                ...
                e === !0 && (U.updateMultisampleRenderTarget(a),
                U.updateRenderTargetMipmap(a))
            }
            x.setRenderTarget(s),
        ...
        function $e(e, t, n, r, i, a) {
            ...
            i.needsUpdate = !0,
            x.renderBufferDirect(n, t, r, i, e, a),
            i.side = 2) : x.renderBufferDirect(n, t, r, i, e, a),
        ...
        function et(e, t, n) {
            ...
            r.fog = t.fog,
            r.envMap = (e.isMeshStandardMaterial ? _e : ge).get(e.envMap || r.environment),
            r.envMapRotation = r.environment !== null && e.envMap === null ? t.environmentRotation : e.envMapRotation,
            l === void 0 && (e.addEventListener(`dispose`, Ve),
            l = new Map,
            r.programs = l);
            let u = l.get(c);
            if (u !== void 0) {
            ...
            let d = r.uniforms;
            return (!e.isShaderMaterial && !e.isRawShaderMaterial || e.clipping === !0) && (d.clippingPlanes = Te.uniform),
            nt(e, s),
            r.needsLights = at(e),
        ...
        function tt(e) {
            if (e.uniformsList === null) {
                ...
                e.uniformsList = As.seqWithValue(t.seq, e.uniforms)
            }
        ...
        function rt(e, t, n, r, i) {
            ...
            let a = t.fog
              ...
              , s = E === null ? x.outputColorSpace : E.isXRRenderTarget === !0 ? E.texture.colorSpace : Ie
            ...
            let C = !1
              ...
              , k = S.getUniforms()
              , A = _.uniforms;
            if (V.useProgram(S.program) && (C = !0,
            w = !0,
            T = !0),
            r.id !== D && (D = r.id,
            w = !0),
            C || O !== e) {
                V.buffers.depth.getReversed() ? (oe.copy(e.projectionMatrix),
                St(oe),
                Ct(oe),
                k.setValue(z, `projectionMatrix`, oe)) : k.setValue(z, `projectionMatrix`, e.projectionMatrix),
                ...
                me.logarithmicDepthBuffer && k.setValue(z, `logDepthBufFC`, 2 / (Math.log(e.far + 1) / Math.LN2)),
                (r.isMeshPhongMaterial || r.isMeshToonMaterial || r.isMeshLambertMaterial || r.isMeshBasicMaterial || r.isMeshStandardMaterial || r.isShaderMaterial) && k.setValue(z, `isOrthographic`, e.isOrthographicCamera === !0),
                O !== e && (O = e,
                w = !0,
                T = !0)
            }
            if (i.isSkinnedMesh) {
                ...
                k.setValue(z, `boneTexture`, e.boneTexture, U))
            }
            i.isBatchedMesh && (k.setOptional(z, i, `batchingTexture`),
            k.setValue(z, `batchingTexture`, i._matricesTexture, U),
            k.setOptional(z, i, `batchingIdTexture`),
            k.setValue(z, `batchingIdTexture`, i._indirectTexture, U),
            k.setOptional(z, i, `batchingColorTexture`),
            i._colorsTexture !== null && k.setValue(z, `batchingColorTexture`, i._colorsTexture, U));
            let j = n.morphAttributes;
            if ((j.position !== void 0 || j.normal !== void 0 || j.color !== void 0) && Oe.update(i, n, S),
            (w || _.receiveShadow !== i.receiveShadow) && (_.receiveShadow = i.receiveShadow,
            k.setValue(z, `receiveShadow`, i.receiveShadow)),
            r.isMeshGouraudMaterial && r.envMap !== null && (A.envMap.value = c,
            A.flipEnvMap.value = c.isCubeTexture && c.isRenderTargetTexture === !1 ? -1 : 1),
            r.isMeshStandardMaterial && r.envMap === null && t.environment !== null && (A.envMapIntensity.value = t.environmentIntensity),
            w && (k.setValue(z, `toneMappingExposure`, x.toneMappingExposure),
            _.needsLights && it(A, T),
            a && r.fog === !0 && Se.refreshFogUniforms(A, a),
            Se.refreshMaterialUniforms(A, r, P, N, v.state.transmissionRenderTarget[e.id]),
            As.upload(z, tt(_), A, U)),
            r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (As.upload(z, tt(_), A, U),
        ...
        this.setRenderTargetTextures = function(e, t, n) {
            ...
            H.get(e.depthTexture).__webglTexture = n;
            let r = H.get(e);
            r.__hasExternalTextures = !0,
            r.__autoAllocateDepthBuffer = n === void 0,
            r.__autoAllocateDepthBuffer || B.has(`WEBGL_multisampled_render_to_texture`) === !0 && (console.warn(`THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided`),
        ...
        this.setRenderTarget = function(e, t=0, n=0) {
            ...
            if (e) {
                ...
                if (s.__useDefaultFramebuffer !== void 0)
                    V.bindFramebuffer(z.FRAMEBUFFER, null),
                    r = !1;
                else if (s.__webglFramebuffer === void 0)
                    U.setupRenderTarget(e);
                else if (s.__hasExternalTextures)
                    U.rebindTextures(e, H.get(e.texture).__webglTexture, H.get(e.depthTexture).__webglTexture);
                else if (e.depthBuffer) {
                    let t = e.depthTexture;
                    if (s.__boundDepthTexture !== t) {
                        if (t !== null && H.has(t) && (e.width !== t.image.width || e.height !== t.image.height))
                ...
                a = !0) : i = e.samples > 0 && U.useMultisampledRTT(e) === !1 ? H.get(e).__webglMultisampledFramebuffer : Array.isArray(l) ? l[n] : l,
                k.copy(e.viewport),
                A.copy(e.scissor),
                j = e.scissorTest
            } else
                ...
                j = L;
            if (V.bindFramebuffer(z.FRAMEBUFFER, i) && r && V.drawBuffers(e, i),
            V.viewport(k),
            V.scissor(A),
            V.setScissorTest(j),
            a) {
                ...
                let r = H.get(e.texture)
                  , i = t || 0;
                z.framebufferTextureLayer(z.FRAMEBUFFER, z.COLOR_ATTACHMENT0, r.__webglTexture, n || 0, i)
            }
            D = -1
        }
        ,
        this.readRenderTargetPixels = function(e, t, n, r, i, a, o) {
            ...
            if (e.isWebGLCubeRenderTarget && o !== void 0 && (s = s[o]),
            s) {
                ...
                try {
                    ...
                    t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && z.readPixels(t, n, r, i, je.convert(s), je.convert(c), a)
                } finally {
                    let e = E === null ? null : H.get(E).__webglFramebuffer;
        ...
        this.readRenderTargetPixelsAsync = async function(e, t, n, r, i, a, o) {
            ...
            s) {
                ...
                if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
                    ...
                    z.readPixels(t, n, r, i, je.convert(c), je.convert(l), 0);
                    let o = E === null ? null : H.get(E).__webglFramebuffer;
                    V.bindFramebuffer(z.FRAMEBUFFER, o);
                    let u = z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE, 0);
                    return z.flush(),
                    await xt(z, u, 4),
                    z.bindBuffer(z.PIXEL_PACK_BUFFER, e),
        ...
        this.copyFramebufferToTexture = function(e, t=null, n=0) {
            e.isTexture !== !0 && (bt(`WebGLRenderer: copyFramebufferToTexture function signature has changed.`),
            t = arguments[0] || null,
            e = arguments[1]);
            let r = 2 ** -n
        ...
        ;
        let ot = z.createFramebuffer()
          , st = z.createFramebuffer();
        this.copyTextureToTexture = function(e, t, n=null, r=null, i=0, a=null) {
            e.isTexture !== !0 && (bt(`WebGLRenderer: copyTextureToTexture function signature has changed.`),
            r = arguments[0] || null,
            e = arguments[1],
            t = arguments[2],
            a = arguments[3] || 0,
            n = null),
            a === null && (i === 0 ? a = 0 : (bt(`WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels.`),
            a = i,
            i = 0));
            ...
            t.isData3DTexture ? (U.setTexture3D(t, 0),
            v = z.TEXTURE_3D) : t.isDataArrayTexture || t.isCompressedArrayTexture ? (U.setTexture2DArray(t, 0),
            v = z.TEXTURE_2D_ARRAY) : (U.setTexture2D(t, 0),
            v = z.TEXTURE_2D),
            ...
            let y = z.getParameter(z.UNPACK_ROW_LENGTH)
              , b = z.getParameter(z.UNPACK_IMAGE_HEIGHT)
              , x = z.getParameter(z.UNPACK_SKIP_PIXELS)
              , S = z.getParameter(z.UNPACK_SKIP_ROWS)
              , C = z.getParameter(z.UNPACK_SKIP_IMAGES);
            z.pixelStorei(z.UNPACK_ROW_LENGTH, h.width),
            z.pixelStorei(z.UNPACK_IMAGE_HEIGHT, h.height),
            z.pixelStorei(z.UNPACK_SKIP_PIXELS, l),
            z.pixelStorei(z.UNPACK_SKIP_ROWS, u),
            z.pixelStorei(z.UNPACK_SKIP_IMAGES, d);
            ...
            if (e.isDepthTexture) {
                ...
                for (let n = 0; n < c; n++)
                    w && (z.framebufferTextureLayer(z.READ_FRAMEBUFFER, z.COLOR_ATTACHMENT0, H.get(e).__webglTexture, i, d + n),
                    z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER, z.COLOR_ATTACHMENT0, H.get(t).__webglTexture, a, m + n)),
                    z.blitFramebuffer(l, u, o, s, f, p, o, s, z.DEPTH_BUFFER_BIT, z.NEAREST);
                ...
                let n = H.get(e)
                  , r = H.get(t);
                V.bindFramebuffer(z.READ_FRAMEBUFFER, ot),
                V.bindFramebuffer(z.DRAW_FRAMEBUFFER, st);
                for (let e = 0; e < c; e++)
                    w ? z.framebufferTextureLayer(z.READ_FRAMEBUFFER, z.COLOR_ATTACHMENT0, n.__webglTexture, i, d + e) : z.framebufferTexture2D(z.READ_FRAMEBUFFER, z.COLOR_ATTACHMENT0, z.TEXTURE_2D, n.__webglTexture, i),
                    T ? z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER, z.COLOR_ATTACHMENT0, r.__webglTexture, a, m + e) : z.framebufferTexture2D(z.DRAW_FRAMEBUFFER, z.COLOR_ATTACHMENT0, z.TEXTURE_2D, r.__webglTexture, a),
                    i === 0 ? T ? z.copyTexSubImage3D(v, a, f, p, m + e, l, u, o, s) : z.copyTexSubImage2D(v, a, f, p, l, u, o, s) : z.blitFramebuffer(l, u, o, s, f, p, o, s, z.COLOR_BUFFER_BIT, z.NEAREST);
                V.bindFramebuffer(z.READ_FRAMEBUFFER, null),
                V.bindFramebuffer(z.DRAW_FRAMEBUFFER, null)
            } else
                T ? e.isDataTexture || e.isData3DTexture ? z.texSubImage3D(v, a, f, p, m, o, s, c, g, _, h.data) : t.isCompressedArrayTexture ? z.compressedTexSubImage3D(v, a, f, p, m, o, s, c, g, h.data) : z.texSubImage3D(v, a, f, p, m, o, s, c, g, _, h) : e.isDataTexture ? z.texSubImage2D(z.TEXTURE_2D, a, f, p, o, s, g, _, h.data) : e.isCompressedTexture ? z.compressedTexSubImage2D(z.TEXTURE_2D, a, f, p, h.width, h.height, g, h.data) : z.texSubImage2D(z.TEXTURE_2D, a, f, p, o, s, g, _, h);
            z.pixelStorei(z.UNPACK_ROW_LENGTH, y),
            z.pixelStorei(z.UNPACK_IMAGE_HEIGHT, b),
            z.pixelStorei(z.UNPACK_SKIP_PIXELS, x),
            z.pixelStorei(z.UNPACK_SKIP_ROWS, S),
            z.pixelStorei(z.UNPACK_SKIP_IMAGES, C),
            a === 0 && t.generateMipmaps && z.generateMipmap(v),
            V.unbindTexture()
        }
        ,
        this.copyTextureToTexture3D = function(e, t, n=null, r=null, i=0) {
            return e.isTexture !== !0 && (bt(`WebGLRenderer: copyTextureToTexture3D function signature has changed.`),
            n = arguments[0] || null,
            r = arguments[1] || null,
            e = arguments[2],
            t = arguments[3],
            i = arguments[4] || 0),
            bt(`WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.`),
        ...
        this.initTexture = function(e) {
            e.isCubeTexture ? U.setTextureCube(e, 0) : e.isData3DTexture ? U.setTexture3D(e, 0) : e.isDataArrayTexture || e.isCompressedArrayTexture ? U.setTexture2DArray(e, 0) : U.setTexture2D(e, 0),
            V.unbindTexture()
        }
        ,
    ...
    set outputColorSpace(e) {
        ...
        t.drawingBufferColorspace = q._getDrawingBufferColorSpace(e),
        t.unpackColorSpace = q._getUnpackColorSpace()
    }
}
  , Hc = {
    type: `change`
  ...
  , Zc = class extends Fa {
    constructor(e, t=null) {
        ...
        this._lastPosition = new Y,
        this._lastQuaternion = new Bt,
        this._lastTargetPosition = new Y,
        this._quat = new Bt().setFromUnitVectors(e.up, new Y(0,1,0)),
        this._quatInverse = this._quat.clone().invert(),
        this._spherical = new Na,
        this._sphericalDelta = new Na,
        this._scale = 1,
        this._panOffset = new Y,
        this._rotateStart = new G,
        this._rotateEnd = new G,
        this._rotateDelta = new G,
        this._panStart = new G,
        this._panEnd = new G,
        this._panDelta = new G,
        this._dollyStart = new G,
        this._dollyEnd = new G,
        this._dollyDelta = new G,
        this._dollyDirection = new Y,
        this._mouse = new G,
        ...
        this._onPointerDown = Qc.bind(this),
        this._onPointerUp = el.bind(this),
        this._onContextMenu = sl.bind(this),
        this._onMouseWheel = rl.bind(this),
        this._onKeyDown = il.bind(this),
        this._onTouchStart = al.bind(this),
        this._onTouchMove = ol.bind(this),
        this._onMouseDown = tl.bind(this),
        this._onMouseMove = nl.bind(this),
        this._interceptControlDown = cl.bind(this),
        this._interceptControlUp = ll.bind(this),
    ...
    update(e=null) {
        ...
        Jc.copy(t).sub(this.target),
        Jc.applyQuaternion(this._quat),
        this._spherical.setFromVector3(Jc),
        this.autoRotate && this.state === $.NONE && this._rotateLeft(this._getAutoRotationAngle(e)),
        ...
        isFinite(n) && isFinite(r) && (n < -Math.PI ? n += Yc : n > Math.PI && (n -= Yc),
        r < -Math.PI ? r += Yc : r > Math.PI && (r -= Yc),
        n <= r ? this._spherical.theta = Math.max(n, Math.min(r, this._spherical.theta)) : this._spherical.theta = this._spherical.theta > (n + r) / 2 ? Math.max(n, this._spherical.theta) : Math.min(r, this._spherical.theta)),
        ...
        if (Jc.setFromSpherical(this._spherical),
        Jc.applyQuaternion(this._quatInverse),
        t.copy(this.target).add(Jc),
        ...
        this.zoomToCursor && this._performCursorZoom) {
            ...
            if (this.object.isPerspectiveCamera) {
                ...
                this.zoomToCursor = !1;
            e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (Gc.origin.copy(this.object.position),
            Gc.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(Gc.direction)) < qc ? this.object.lookAt(this.target) : (Kc.setFromNormalAndCoplanarPoint(this.object.up, this.target),
            Gc.intersectPlane(Kc, this.target))))
        } else if (this.object.isOrthographicCamera) {
        ...
        this._performCursorZoom = !1,
        i || this._lastPosition.distanceToSquared(this.object.position) > Xc || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Xc || this._lastTargetPosition.distanceToSquared(this.target) > Xc ? (this.dispatchEvent(Hc),
    ...
    _getAutoRotationAngle(e) {
        return e === null ? Yc / 60 / 60 * this.autoRotateSpeed : Yc / 60 * this.autoRotateSpeed * e
    }
    _getZoomScale(e) {
        let t = Math.abs(e * .01);
    ...
    _panLeft(e, t) {
        Jc.setFromMatrixColumn(t, 0),
        Jc.multiplyScalar(-e),
        this._panOffset.add(Jc)
    }
    _panUp(e, t) {
        this.screenSpacePanning === !0 ? Jc.setFromMatrixColumn(t, 1) : (Jc.setFromMatrixColumn(t, 0),
        Jc.crossVectors(this.object.up, Jc)),
        Jc.multiplyScalar(e),
        this._panOffset.add(Jc)
    }
    _pan(e, t) {
    ...
    _handleMouseMoveRotate(e) {
        ...
        this._rotateLeft(Yc * this._rotateDelta.x / t.clientHeight),
    ...
    _handleKeyDown(e) {
        ...
        switch (e.code) {
        case this.keys.UP:
            e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(Yc * this.rotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed),
            t = !0;
            break;
        case this.keys.BOTTOM:
            ...
            break;
        case this.keys.LEFT:
            e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(Yc * this.rotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0),
            t = !0;
            break;
...
;
function Qc(e) {
    this.enabled !== !1 && (this._pointers.length === 0 && (this.domElement.setPointerCapture(e.pointerId),
...
function tl(e) {
    ...
    this.state !== $.NONE && this.dispatchEvent(Uc)
}
function nl(e) {
    switch (this.state) {
    case $.ROTATE:
...
function rl(e) {
    this.enabled !== !1 && this.enableZoom !== !1 && this.state === $.NONE && (e.preventDefault(),
...
function cl(e) {
    e.key === `Control` && (this._controlActive = !0,
...
function ll(e) {
    e.key === `Control` && (this._controlActive = !1,
...
var ul = n();
function dl({exploded: e=!1, activeLayer: t=null}) {
    let n = (0,
    r.useRef)(null)
      , i = (0,
    r.useRef)(t);
    ...
    r.useEffect)( () => {
        ...
        let r = t.clientWidth
          , a = t.clientHeight
          , o = new si;
        o.fog = new oi(793134,36,110);
        let s = document.createElement(`canvas`);
        s.width = 1024,
        s.height = 512;
        let c = s.getContext(`2d`)
          , l = c.createLinearGradient(0, 0, 0, 512);
        l.addColorStop(0, `#0a1424`),
        l.addColorStop(.5, `#15263f`),
        l.addColorStop(.74, `#3a3a4a`),
        l.addColorStop(.9, `#6b4a3a`),
        l.addColorStop(1, `#3a2a22`),
        c.fillStyle = l,
        c.fillRect(0, 0, 1024, 512);
        let u = new ki(s);
        u.mapping = 303,
        o.background = u;
        let d = new ei(40,r / a,.1,240);
        d.position.set(24, 15, 28);
        let f = new Vc({
            antialias: !0
        });
        ...
        f.shadowMap.type = 2,
        f.toneMapping = 4,
        f.toneMappingExposure = 1.12,
        t.appendChild(f.domElement);
        let p = new co(f)
          , m = p.fromEquirectangular(u);
        o.environment = m.texture,
        p.dispose();
        let h = new Zc(d,f.domElement);
        h.enableDamping = !0,
        h.dampingFactor = .07,
        h.enablePan = !1,
        h.minDistance = 17,
        h.maxDistance = 52,
        h.maxPolarAngle = Math.PI / 2.08,
        h.target.set(0, 2.6, 0),
        h.autoRotate = !0,
        h.autoRotateSpeed = .38,
        o.add(new _a(7045030,.45));
        let g = new ia(9414344,2763298,.55);
        o.add(g);
        let _ = new ga(16757370,1.35);
        _.position.set(-22, 14, 18),
        _.castShadow = !0,
        _.shadow.mapSize.set(2048, 2048),
        _.shadow.camera.left = -30,
        _.shadow.camera.right = 30,
        _.shadow.camera.top = 30,
        _.shadow.camera.bottom = -30,
        _.shadow.bias = -3e-4,
        _.shadow.normalBias = .02,
        o.add(_);
        let v = new ga(4876954,.5);
        v.position.set(16, 12, -16),
        o.add(v);
        let y = new pa(16757598,.9,22,2);
        y.position.set(0, 2.2, 1),
        o.add(y);
        let b = new pa(16762992,.7,18,2);
        b.position.set(0, 4.6, 0),
        o.add(b);
        let x = new Rr(new Ri(180,180),new Bi({
            color: 923682,
            roughness: 1
        }));
        ...
        x.receiveShadow = !0,
        o.add(x);
        let S = new Rr(new Ri(46,46),new Bi({
            color: 1781798,
            roughness: 1
        }));
        ...
        S.receiveShadow = !0,
        o.add(S);
        let C = new Pa(180,90,2767442,1450028);
        C.position.y = .015,
        ...
        let D = new Bi({
          ...
          , ne = e => {
            let t = new Di(new Li(e.geometry,1),P);
            return e.add(t),
            e
        }
          , F = (e, t, n, r, i=!0) => {
            let a = new Rr(new Vr(e,t,n),r);
          ...
          , R = new Oi;
        o.add(re, I, L, ie, R);
        let ae = F(11.4, .6, 9.4, T);
        ae.position.y = .3,
        re.add(ae);
        let oe = F(10, .2, 8, w);
        oe.position.y = .7,
        I.add(oe);
        let se = F(10, 2.7, .22, w);
        se.position.set(0, 2.15, -3.9),
        I.add(se);
        let ce = F(.22, 2.7, 8, w);
        ce.position.set(-4.9, 2.15, 0),
        I.add(ce);
        let le = F(3.4, 2.7, .22, w);
        le.position.set(-3.3, 2.15, 3.9),
        I.add(le);
        let ue = F(1.6, 2.7, .3, E);
        ue.position.set(-1.6, 2.15, 3.78),
        I.add(ue);
        let de = F(.22, 2.7, 3.4, w);
        de.position.set(4.9, 2.15, -2.3),
        I.add(de);
        let fe = new Rr(new Ri(5.4,2.3),O);
        fe.position.set(1.6, 2.15, 3.87),
        I.add(fe);
        let z = new Rr(new Ri(4.4,2.3),O);
        z.position.set(4.87, 2.15, .4),
        z.rotation.y = Math.PI / 2,
        I.add(z),
        [-.4, 1.6, 3.6].forEach(e => {
            let t = F(.06, 2.3, .06, k, !1);
            t.position.set(1.6 + e, 2.15, 3.9),
            I.add(t)
        }
        );
        let pe = F(.16, 2.4, 5, E);
        pe.position.set(-4.74, 2.05, 0),
        I.add(pe),
        [-3.8, 3.8].forEach(e => {
            let t = F(.3, 2.8, .3, k, !1);
            t.position.set(e, 1.6, 4.4),
            I.add(t)
        }
        );
        let B = F(11.4, .22, 9.4, w);
        B.position.y = 3.3,
        L.add(B);
        let me = F(11.4, 2.5, .22, E);
        me.position.set(0, 4.55, -4.4),
        L.add(me);
        let V = F(.22, 2.5, 9.4, E);
        V.position.set(-5.6, 4.55, 0),
        L.add(V);
        let he = F(.22, 2.5, 9.4, E);
        he.position.set(5.6, 4.55, 0),
        L.add(he);
        let H = F(11.4, .7, .22, E);
        H.position.set(0, 3.95, 4.4),
        L.add(H);
        let U = F(11.4, .7, .22, E);
        U.position.set(0, 5.15, 4.4),
        L.add(U);
        let ge = new Rr(new Ri(10.6,1),D);
        ge.position.set(0, 4.55, 4.37),
        L.add(ge),
        [-4, -1.3, 1.3, 4].forEach(e => {
            let t = F(.06, 1, .06, k, !1);
            t.position.set(e, 4.55, 4.4),
            L.add(t)
        }
        );
        let _e = new Rr(new Ri(8.6,1),O);
        _e.position.set(5.57, 4.55, 0),
        _e.rotation.y = Math.PI / 2,
        L.add(_e);
        let ve = F(11.8, .25, 9.8, w);
        ve.position.y = 0,
        ie.add(ve),
        [[11.8, .5, .16, 0, .25, 4.8], [11.8, .5, .16, 0, .25, -4.8], [.16, .5, 9.8, 5.8, .25, 0], [.16, .5, 9.8, -5.8, .25, 0]].forEach( ([e,t,n,r,i,a]) => {
            let o = F(e, t, n, T);
            o.position.set(r, i, a),
            ie.add(o)
        }
        );
        let ye = new Rr(new Vr(5.4,.32,3.2),A);
        ye.position.set(.4, .16, 8.6),
        ye.receiveShadow = !0,
        R.add(ye);
        let be = F(7, .1, 4.6, w, !1);
        be.position.set(.4, .05, 8.6),
        R.add(be);
        let xe = F(6, .18, .18, E, !1);
        xe.position.set(1.6, 3, 6.4),
        R.add(xe);
        let Se = F(6, .18, .18, E, !1);
        Se.position.set(1.6, 3, 7.4),
        R.add(Se);
        for (let e = 0; e < 7; e++) {
            let t = F(.12, .12, 1.4, E, !1);
            t.position.set(-1.4 + e * 1, 3, 6.9),
            R.add(t)
        }
        [-1.4, 4.6].forEach(e => {
            let t = F(.16, 3, .16, k, !1);
            t.position.set(e, 1.5, 6.9),
            R.add(t)
        }
        );
        let Ce = F(3.2, .05, 10, M, !1);
        Ce.position.set(0, .03, 15),
        R.add(Ce);
        let we = F(9, .9, .3, M, !1);
        we.position.set(0, .45, -7.2),
        R.add(we);
        let Te = F(9, .4, .7, ee, !1);
        Te.position.set(0, .5, -6.9),
        R.add(Te),
        [-7.8, 7.8].forEach(e => {
            let t = F(1, .3, 6, ee, !1);
            t.position.set(e, .15, 5),
            R.add(t)
        }
        ),
        [[-6.8, 7], [6.8, 7], [-6.8, 10.5], [6.8, 10.5], [-8.2, 3], [8.2, 3], [3.5, 11.5], [-3.5, 11.5]].forEach( ([e,t]) => {
            let n = new Rr(new zi(.5,10,8),j);
            n.position.set(e, .5, t),
            n.castShadow = !0,
            R.add(n)
        }
        ),
        [[-2.5, 6], [2.5, 6], [-2.5, 9], [2.5, 9], [-3.5, 12], [3.5, 12]].forEach( ([e,t]) => {
            let n = F(.06, .5, .06, k, !1);
            n.position.set(e, .25, t),
            R.add(n);
            let r = new Rr(new zi(.12,10,8),N);
            r.position.set(e, .55, t),
            R.add(r)
        }
        );
        let Ee = (e, t, n=1) => {
            let r = new Rr(new ji(.16,.22,1.8,8),te);
            r.position.set(e, .9 * n, t),
            r.castShadow = !0,
            R.add(r);
            let i = new Rr(new Mi(1.5 * n,3.4 * n,10),j);
            i.position.set(e, 3 * n, t),
            i.castShadow = !0,
            R.add(i);
            let a = new Rr(new Mi(1.2 * n,2.6 * n,10),ee);
            a.position.set(e, 3.9 * n, t),
            a.castShadow = !0,
            R.add(a)
        }
        ;
        [[-9, -6], [9, -7], [-8, 8], [10, 6], [-11.5, 0], [11.5, -1], [-7, -10.5], [8, -11.5], [-12.5, 6], [12.5, 9], [-10, 10], [10.5, -10]].forEach( ([e,t]) => Ee(e, t, 1)),
        [-6.2, 6.2].forEach(e => {
            let t = F(13, 1, .5, j, !1);
            t.position.set(0, .5, e + (e > 0 ? 5.4 : -5.4)),
            R.add(t)
        }
        );
        let De = [re, I, L, ie, R];
        o.traverse(e => {
            e.isMesh && e.material && (e.material = e.material.clone(),
            e.material.userData.orig = {
        ...
        let Oe, ke = null, Ae = new ya, je = e => {
            De.forEach( (t, n) => {
                t.traverse(t => {
                    if (!t.isMesh || !t.material || !t.material.userData.orig)
                        return;
                    let r = t.material.userData.orig;
                    e === null ? (t.material.emissive.copy(r.emissive),
                    t.material.emissiveIntensity = r.emissiveIntensity,
                    t.material.opacity = r.opacity,
                    t.material.transparent = r.transparent) : n === e ? (t.material.emissive.set(6333946),
                    t.material.emissiveIntensity = .6,
                    t.material.opacity = r.opacity,
                    t.material.transparent = r.transparent) : (t.material.emissive.copy(r.emissive),
                    t.material.emissiveIntensity = r.emissiveIntensity * .3,
                    t.material.opacity = Math.min(r.opacity, .14),
        ...
        , Me = () => {
            Oe = requestAnimationFrame(Me);
            let t = Ae.getElapsedTime()
              , n = +!!e;
            re.position.y = 0,
            I.position.y = n * 2.6,
            L.position.y = n * 5.6,
            ie.position.y = 6.2 + n * 2.8,
            i.current !== ke && (ke = i.current,
            je(ke)),
            ye.material.opacity = .74 + Math.sin(t * 1.4) * .06,
            h.update(),
            f.render(o, d)
        }
        ;
        ...
        () => {
            ...
            h.dispose(),
            f.dispose(),
            f.domElement.parentNode === t && t.removeChild(f.domElement),
            o.traverse(e => {
