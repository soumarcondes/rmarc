...
t.exports)
  ...
  , u = (n, r, o) => (o = n == null ? {} : e(i(n)),
l(r || !n || !n.__esModule || !a.call(n, `default`) ? t(o, `default`, {
    value: n,
    enumerable: !0
}) : o, n))
  ...
  , f = s((e => {
    var t = Symbol.for(`react.element`)
      ...
      , f = Symbol.iterator;
    function p(e) {
        return typeof e != `object` || !e ? null : (e = f && e[f] || e[`@@iterator`],
    ...
    function j(e, r, i, a, o) {
        ...
        if (c)
            ...
            j(o, r, i, ``, function(e) {
                return e
            })) : o != null && (D(o) && (o = E(o, i + (!o.key || c && c.key === o.key ? `` : (`` + o.key).replace(k, `$&/`) + `/`) + e)),
            r.push(o)),
            1;
        if (c = 0,
        a = a === `` ? `.` : a + `:`,
    ...
    e.cloneElement = function(e, n, r) {
        ...
        if (n != null) {
            ...
            for (l in n)
                S.call(n, l) && !w.hasOwnProperty(l) && (i[l] = n[l] === void 0 && c !== void 0 ? c[l] : n[l])
        }
